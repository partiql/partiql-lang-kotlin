 ...
 */
@Suppress("ClassName")
public class PlanBuilder private constructor(private val factory: PlanFactory) {
    ...
    public fun rexStruct(
        fields: MutableList<StructPart> = mutableListOf(),
        block: _RexStruct.() ->
        Unit = {}
    ): Rex.Struct {
    ...
    public fun rexSubqueryCollection(
        rel: Rel? = null,
        block: _RexSubqueryCollection.() -> Unit =
            {}
    ): Rex.Subquery.Collection {
        val b = _RexSubqueryCollection(rel)
        b.block()
        return factory.rexSubqueryCollection(rel = b.rel!!)
    }
    ...
    public class _RexSubqueryCollection(
        public var rel: Rel? = null
    )
