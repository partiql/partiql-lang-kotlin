...
public class ArgValueBuilder {
    public var name: String? = null

    public var `value`: Rex? = null

    public fun name(name: String?): ArgValueBuilder = this.apply {
        this.name = name
    }

    public fun `value`(`value`: Rex?): ArgValueBuilder = this.apply {
        this.`value` = `value`
    }

    public fun build(): Arg.Value = build(PlanFactory.DEFAULT)

    public fun build(factory: PlanFactory = PlanFactory.DEFAULT): Arg.Value = factory.argValue(
        name =
        name,
        value = value!!
    )
...
public class ArgTypeBuilder {
    public var name: String? = null

    public var type: StaticType? = null

    public fun name(name: String?): ArgTypeBuilder = this.apply {
        this.name = name
    }

    public fun type(type: StaticType?): ArgTypeBuilder = this.apply {
        this.type = type
    }

    public fun build(): Arg.Type = build(PlanFactory.DEFAULT)

    public fun build(factory: PlanFactory = PlanFactory.DEFAULT): Arg.Type = factory.argType(
        name =
        name,
        type = type!!
    )
...
public class BranchBuilder {
    ...
    public fun condition(condition: Rex?): BranchBuilder = this.apply {
        this.condition = condition
    }

    public fun `value`(`value`: Rex?): BranchBuilder = this.apply {
        this.`value` = `value`
    }

    public fun build(): Branch = build(PlanFactory.DEFAULT)

    public fun build(factory: PlanFactory = PlanFactory.DEFAULT): Branch = factory.branch(
        condition =
        condition!!,
        value = value!!
    )
...
public class RexCallBuilder {
    ...
    public var args: MutableList<Arg> = mutableListOf()
    ...
    public fun args(args: MutableList<Arg>): RexCallBuilder = this.apply {
        this.args = args
    }
...
public class RexSwitchBuilder {
    public var match: Rex? = null

    public var branches: MutableList<Branch> = mutableListOf()
    ...
    public fun branches(branches: MutableList<Branch>): RexSwitchBuilder = this.apply {
        this.branches = branches
    }

    public fun default(default: Rex?): RexSwitchBuilder = this.apply {
...
public class RexQueryScalarSubqueryBuilder {
    public var query: Rex.Query.Collection? = null

    public var type: StaticType? = null

    public fun query(query: Rex.Query.Collection?): RexQueryScalarSubqueryBuilder = this.apply {
        this.query = query
    }

    public fun type(type: StaticType?): RexQueryScalarSubqueryBuilder = this.apply {
        this.type = type
    }

    public fun build(): Rex.Query.Scalar.Subquery = build(PlanFactory.DEFAULT)

    public fun build(factory: PlanFactory = PlanFactory.DEFAULT): Rex.Query.Scalar.Subquery =
        factory.rexQueryScalarSubquery(query = query!!, type = type)
}
