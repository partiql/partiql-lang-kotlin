...
public class IonSchema private constructor() {
    ...
    public class Builder(
        ...
        public fun typeImport(
            ...
            b.block()
            return factory.typeImport(schema = b.schema!!, type = b.type!!, nullable = b.nullable ?: false)
        }
        ...
        public fun constraintRegex(
            pattern: String? = null,
            flags: MutableList<RegexFlag> = mutableListOf(),
        ...
        public fun rangeNumber(
            ...
            b.block()
            return factory.rangeNumber(lower = b.lower, upper = b.upper, bounds = b.bounds ?: Bounds.INCLUSIVE)
        }
        ...
        public fun rangeTimestamp(
            ...
            b.block()
            return factory.rangeTimestamp(lower = b.lower, upper = b.upper, bounds = b.bounds ?: Bounds.INCLUSIVE)
        }
        ...
        public fun rangeTimestampPrecision(
            ...
            b.block()
            return factory.rangeTimestampPrecision(lower = b.lower, upper = b.upper, bounds = b.bounds ?: Bounds.INCLUSIVE)
        }
        ...
        public class _ConstraintRegex(
            ...
            public var flags: MutableList<RegexFlag> = mutableListOf()
        )
