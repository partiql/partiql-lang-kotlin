...
//
// /**
// * This class will "unplan" a query back to an AST.
// */
// @Suppress("PARAMETER_NAME_CHANGED_ON_OVERRIDE")
// open class PartiQLTarget() : TranspilerTarget() {
//
//     override val target: String = "partiql"
//
//     private val factory: AstFactory = Ast
//
//     private val catalog: Catalog = Catalog.partiql()
//
//     private inline fun <T : AstNode> unplan(block: AstFactory.() -> T): T = factory.block()
//
//     override fun defaultReturn(node: PlanNode, schema: Schema) =
//         throw UnsupportedOperationException("Cannot unplan $node")
//
//     // Verify Types and Functions
//
//     /**
//      * Override for your dialect's types
//      */
//     open fun verifyType(type: Type.Ref): Type.Atomic {
//         return try {
//             catalog.lookup(type)
//         } catch (_: IllegalArgumentException) {
//             // type is missing from this catalog
//             error("Expected catalog to have type ${type.annotation}::${type.ordinal}, but was missing")
//         }
//     }
//
//     /**
//      * Override for your dialect's functions
//      */
//     open fun verifyFn(fn: Fn.Ref): Fn {
//         return when (fn) {
//             is Fn.Ref.Resolved -> {
//                 try {
//                     catalog.lookup(fn)
//                 } catch (_: IllegalArgumentException) {
//                     // fn is missing from this catalog
//                     error("Expected catalog to have ${fn.annotation}::${fn.ordinal}, but was missing")
//                 }
//             }
//             is Fn.Ref.Unresolved -> error("unresolved function ${fn.identifier}")
//         }
//     }
//
//     // Statement
