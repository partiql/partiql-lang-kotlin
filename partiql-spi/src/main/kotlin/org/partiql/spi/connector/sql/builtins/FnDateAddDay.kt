...
@OptIn(PartiQLValueExperimental::class, FnExperimental::class)
internal object Fn_DATE_ADD_DAY__INT32_TIME__TIME : Fn {
...
@OptIn(PartiQLValueExperimental::class, FnExperimental::class)
internal object Fn_DATE_ADD_DAY__INT64_TIME__TIME : Fn {
...
@OptIn(PartiQLValueExperimental::class, FnExperimental::class)
internal object Fn_DATE_ADD_DAY__INT_TIME__TIME : Fn {
