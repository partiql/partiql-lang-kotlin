...
internal object Fn_DIVIDE__NUMERIC_NUMERIC__NUMERIC {
    @OptIn(FnExperimental::class, PartiQLValueExperimental::class)
    val ALL = buildList<Fn> {
        FnUtils.numericDivisionTypes().forEach { numeric ->
            val fn = object : Fn {
                override val signature = FnSignature(
                    name = "minus",
...
@OptIn(PartiQLValueExperimental::class, FnExperimental::class)
internal object Fn_DIVIDE__BIGNUMERIC_BIGNUMERIC__BIGNUMERIC : Fn {
