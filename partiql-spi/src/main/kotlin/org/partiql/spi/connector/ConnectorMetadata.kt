...
public interface ConnectorMetadata {
     ...
     */
    public fun getObject(path: BindingPath): ConnectorHandle<ConnectorObject>?

    /**
     * Returns a list of scalar functions defined at the given path.
     *
     * @param path
     * @return
     */
    public fun getScalarFunctions(path: BindingPath): List<ConnectorHandle<FunctionSignature.Scalar>>

    /**
     * Returns a list of aggregation functions defined at the given path.
     *
     * @param path
     * @return
     */
    public fun getAggregationFunctions(path: BindingPath): List<ConnectorHandle<FunctionSignature.Aggregation>>
}
