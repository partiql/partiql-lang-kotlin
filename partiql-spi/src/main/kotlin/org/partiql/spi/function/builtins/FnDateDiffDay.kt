...
internal val Fn_DATE_DIFF_DAY__DATE_DATE__INT64 = FunctionUtils.hidden(
    ...
    val dayDiff = ChronoUnit.DAYS.between(date1, date2)
    Datum.bigint(dayDiff)
}
...
internal val Fn_DATE_DIFF_DAY__TIMESTAMP_TIMESTAMP__INT64 = FunctionUtils.hidden(
    ...
    val dayDiff = ChronoUnit.DAYS.between(timestamp1, timestamp2)
    Datum.bigint(dayDiff)
}

internal val Fn_DATE_DIFF_DAY__TIMESTAMPZ_TIMESTAMPZ__INT64 = FunctionUtils.hidden(
    ...
    val dayDiff = ChronoUnit.DAYS.between(timestampz1, timestampz2)
    Datum.bigint(dayDiff)
}
