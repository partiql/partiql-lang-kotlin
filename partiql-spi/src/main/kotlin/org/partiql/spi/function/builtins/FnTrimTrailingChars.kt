...
internal object FnTrimTrailingChars : FnOverload() {
    ...
    override fun getSignature(): RoutineOverloadSignature {
        return RoutineOverloadSignature(FunctionUtils.hide("trim_trailing_chars"), listOf(PType.dynamic(), PType.dynamic()))
    }
    ...
    override fun getInstance(args: Array<PType>): Fn? {
        ...
        return Function.instance(
            ...
            valueType.stringFnResult(value.codepointTrimTrailing(chars), length)
        }
    }
}
