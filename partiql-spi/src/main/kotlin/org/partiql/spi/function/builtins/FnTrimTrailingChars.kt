...
internal object FnTrimTrailingChars : FnOverload() {
    ...
    override fun getInstance(args: Array<PType>): Fn? {
        ...
        if (args.any { it.code() == PType.UNKNOWN }) {
            return FnUtils.nullResolutionInstance(FunctionUtils.hide("trim_trailing_chars"), PType.string(), args)
        }
        return when (valueType.code()) {
            PType.CHAR, PType.VARCHAR -> Function.instance(
                ...
                val result = args[0].string.codepointTrimTrailing(args[1].string)
            ...
            PType.CLOB -> Function.instance(
                ...
                val result = args[0].bytes.toString(Charsets.UTF_8).codepointTrimTrailing(args[1].string)
