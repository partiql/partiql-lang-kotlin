...
abstract class DatumComparator implements Comparator<Datum> {
    ...
    private static Map<PType.Kind, Integer> initializeTypePrecedence() {
        ...
        precedence.put(PType.Kind.INT, 1);
        precedence.put(PType.Kind.BIGINT, 1);
        precedence.put(PType.Kind.INT_ARBITRARY, 1);
        precedence.put(PType.Kind.DECIMAL, 1);
        precedence.put(PType.Kind.DECIMAL_ARBITRARY, 1);
        precedence.put(PType.Kind.REAL, 1);
        precedence.put(PType.Kind.DOUBLE_PRECISION, 1);
        // Date Type
        precedence.put(PType.Kind.DATE, 2);
        // Time Type
        precedence.put(PType.Kind.TIME_WITH_TZ, 3);
        precedence.put(PType.Kind.TIME_WITHOUT_TZ, 3);
        // Timestamp Types
        precedence.put(PType.Kind.TIMESTAMP_WITH_TZ, 4);
        precedence.put(PType.Kind.TIMESTAMP_WITHOUT_TZ, 4);
        // Text Types
        ...
        // Array Type
        precedence.put(PType.Kind.LIST, 7);
        // Sexp Type
    ...
    private static DatumComparison[] fillTinyIntComparator(DatumComparison[] comps) {
        ...
        comps[PType.Kind.INT.ordinal()] = (self, intNum, comp) -> Integer.compare(self.getByte(), intNum.getInt());
        comps[PType.Kind.BIGINT.ordinal()] = (self, bigInt, comp) -> Long.compare(self.getByte(), bigInt.getLong());
        comps[PType.Kind.INT_ARBITRARY.ordinal()] = (self, intArbitrary, comp) -> BigInteger.valueOf(self.getByte()).compareTo(intArbitrary.getBigInteger());
        comps[PType.Kind.REAL.ordinal()] = (self, real, comp) ->  compareDoubleRhs(real.getFloat(), () -> Float.compare(self.getByte(), real.getFloat()));
        comps[PType.Kind.DOUBLE_PRECISION.ordinal()] = (self, doublePrecision, comp) -> compareDoubleRhs(doublePrecision.getDouble(), () -> Double.compare(self.getByte(), doublePrecision.getDouble()));
    ...
    private static DatumComparison[] fillSmallIntComparator(DatumComparison[] comps) {
        ...
        comps[PType.Kind.INT.ordinal()] = (self, intNum, comp) -> Integer.compare(self.getShort(), intNum.getInt());
        comps[PType.Kind.BIGINT.ordinal()] = (self, bigInt, comp) -> Long.compare(self.getShort(), bigInt.getLong());
        comps[PType.Kind.INT_ARBITRARY.ordinal()] = (self, intArbitrary, comp) -> BigInteger.valueOf(self.getShort()).compareTo(intArbitrary.getBigInteger());
        comps[PType.Kind.REAL.ordinal()] = (self, real, comp) ->  compareDoubleRhs(real.getFloat(), () -> Float.compare(self.getShort(), real.getFloat()));
        comps[PType.Kind.DOUBLE_PRECISION.ordinal()] = (self, doublePrecision, comp) -> compareDoubleRhs(doublePrecision.getDouble(), () -> Double.compare(self.getShort(), doublePrecision.getDouble()));
    ...
    private static DatumComparison[] fillIntComparator(DatumComparison[] comps) {
        ...
        comps[PType.Kind.INT.ordinal()] = (self, intNum, comp) -> Integer.compare(self.getInt(), intNum.getInt());
        comps[PType.Kind.BIGINT.ordinal()] = (self, bigInt, comp) -> Long.compare(self.getInt(), bigInt.getLong());
        comps[PType.Kind.INT_ARBITRARY.ordinal()] = (self, intArbitrary, comp) -> BigInteger.valueOf(self.getInt()).compareTo(intArbitrary.getBigInteger());
        comps[PType.Kind.REAL.ordinal()] = (self, real, comp) ->  compareDoubleRhs(real.getFloat(), () -> Float.compare(self.getInt(), real.getFloat()));
        comps[PType.Kind.DOUBLE_PRECISION.ordinal()] = (self, doublePrecision, comp) -> compareDoubleRhs(doublePrecision.getDouble(), () -> Double.compare(self.getInt(), doublePrecision.getDouble()));
    ...
    private static DatumComparison[] fillBigIntComparator(DatumComparison[] comps) {
        ...
        comps[PType.Kind.INT.ordinal()] = (self, intNum, comp) -> Long.compare(self.getLong(), intNum.getInt());
        comps[PType.Kind.BIGINT.ordinal()] = (self, bigInt, comp) -> Long.compare(self.getLong(), bigInt.getLong());
        comps[PType.Kind.INT_ARBITRARY.ordinal()] = (self, intArbitrary, comp) -> BigInteger.valueOf(self.getLong()).compareTo(intArbitrary.getBigInteger());
        comps[PType.Kind.REAL.ordinal()] = (self, real, comp) ->  compareDoubleRhs(real.getFloat(), () -> Float.compare(self.getLong(), real.getFloat()));
        comps[PType.Kind.DOUBLE_PRECISION.ordinal()] = (self, doublePrecision, comp) -> compareDoubleRhs(doublePrecision.getDouble(), () -> Double.compare(self.getLong(), doublePrecision.getDouble()));
    ...
    private static DatumComparison[] fillIntArbitraryComparator(DatumComparison[] comps) {
        ...
        comps[PType.Kind.INT.ordinal()] = (self, intNum, comp) -> self.getBigInteger().compareTo(BigInteger.valueOf(intNum.getInt()));
        comps[PType.Kind.BIGINT.ordinal()] = (self, bigInt, comp) -> self.getBigInteger().compareTo(BigInteger.valueOf(bigInt.getLong()));
        comps[PType.Kind.INT_ARBITRARY.ordinal()] = (self, intArbitrary, comp) -> self.getBigInteger().compareTo(intArbitrary.getBigInteger());
        ...
        comps[PType.Kind.DOUBLE_PRECISION.ordinal()] = (self, doublePrecision, comp) -> compareDoubleRhs(doublePrecision.getDouble(), () -> new BigDecimal(self.getBigInteger()).compareTo(BigDecimal.valueOf(doublePrecision.getDouble())));
    ...
    private static DatumComparison[] fillRealComparator(DatumComparison[] comps) {
        ...
        comps[PType.Kind.INT.ordinal()] = (self, intNum, comp) -> compareDoubleLhs(self.getFloat(), () -> Float.compare(self.getFloat(), intNum.getInt()));
        ...
        comps[PType.Kind.INT_ARBITRARY.ordinal()] = (self, intArbitrary, comp) -> compareDoubleLhs(self.getFloat(), () -> Float.compare(self.getFloat(), intArbitrary.getBigInteger().floatValue()));
        ...
        comps[PType.Kind.DOUBLE_PRECISION.ordinal()] = (self, doublePrecision, comp) -> {
    ...
    private static DatumComparison[] fillDoubleComparator(DatumComparison[] comps) {
        ...
        comps[PType.Kind.INT.ordinal()] = (self, intNum, comp) -> compareDoubleLhs(self.getDouble(), () -> Double.compare(self.getDouble(), intNum.getInt()));
        ...
        comps[PType.Kind.INT_ARBITRARY.ordinal()] = (self, intArbitrary, comp) -> compareDoubleLhs(self.getDouble(), () -> Double.compare(self.getDouble(), intArbitrary.getBigInteger().doubleValue()));
        ...
        comps[PType.Kind.DOUBLE_PRECISION.ordinal()] = (self, doublePrecision, comp) -> compareDoubles(self.getDouble(), doublePrecision.getDouble(), () -> Double.compare(self.getDouble(), doublePrecision.getDouble()));
    ...
    private static DatumComparison[] fillDecimalComparator(DatumComparison[] comps) {
        ...
        comps[PType.Kind.INT.ordinal()] = (self, intNum, comp) -> self.getBigDecimal().compareTo(BigDecimal.valueOf(intNum.getInt()));
        comps[PType.Kind.BIGINT.ordinal()] = (self, bigInt, comp) -> self.getBigDecimal().compareTo(BigDecimal.valueOf(bigInt.getLong()));
        comps[PType.Kind.INT_ARBITRARY.ordinal()] = (self, intArbitrary, comp) -> self.getBigDecimal().compareTo(new BigDecimal(intArbitrary.getBigInteger()));
        ...
        comps[PType.Kind.DOUBLE_PRECISION.ordinal()] = (self, doublePrecision, comp) -> compareDoubleRhs(doublePrecision.getDouble(), () -> self.getBigDecimal().compareTo(BigDecimal.valueOf(doublePrecision.getDouble())));
    ...
    /**
     * Used for both {@link PType.Kind#TIME_WITHOUT_TZ} and {@link PType.Kind#TIME_WITH_TZ}
    ...
    private static DatumComparison[] fillTimeComparator(DatumComparison[] comps) {
        comps[PType.Kind.TIME_WITHOUT_TZ.ordinal()] = (self, time, comp) -> self.getTime().compareTo(time.getTime());
        comps[PType.Kind.TIME_WITH_TZ.ordinal()] = (self, time, comp) -> self.getTime().compareTo(time.getTime());
        return comps;
    }

    /**
     * Used for both {@link PType.Kind#TIMESTAMP_WITHOUT_TZ} and {@link PType.Kind#TIMESTAMP_WITH_TZ}
     * @param comps the array of {@link DatumComparison} to modify. Each {@link DatumComparison} is indexed by the other
     * {@link Datum}'s {@link PType.Kind#ordinal()}.
     * @return the modified array
     */
    private static DatumComparison[] fillTimestampComparator(DatumComparison[] comps) {
        comps[PType.Kind.TIMESTAMP_WITH_TZ.ordinal()] = (self, timestamp, comp) -> self.getTimestamp().compareTo(timestamp.getTimestamp());
        comps[PType.Kind.TIMESTAMP_WITHOUT_TZ.ordinal()] = (self, timestamp, comp) -> self.getTimestamp().compareTo(timestamp.getTimestamp());
        return comps;
    }
    ...
    private static DatumComparison[] fillListComparator(DatumComparison[] comps) {
        comps[PType.Kind.LIST.ordinal()] = (self, list, comp) -> compareOrdered(self.iterator(), list.iterator(), comp);
        return comps;
    }
