...
import org.partiql.lang.eval.builtins.internal.PartiQLFunctionBinaryNumeric
import org.partiql.lang.eval.builtins.internal.PartiQLFunctionMeasure
import org.partiql.lang.eval.builtins.internal.PartiQLFunctionUnaryNumeric
...
internal val SCALAR_BUILTINS_SQL = listOf(
    ...
    PartiQLFunctionMod,
    PartiQLFunctionCeil,
    PartiQLFunctionCeiling,
    PartiQLFunctionFloor,
    PartiQLFunctionSqrt,
    PartiQLFunctionExp,
    PartiQLFunctionPow,
    PartiQLFunctionLn,
    PartiQLFunctionLower,
    PartiQLFunctionUpper,
    PartiQLFunctionBitLength,
    PartiQLFunctionCharLength,
    PartiQLFunctionCharacterLength,
    PartiQLFunctionOctetLength,
    PartiQLFunctionSubstring_1,
    PartiQLFunctionSubstring_2,
    PartiQLFunctionTrim_1,
    PartiQLFunctionTrim_2,
    PartiQLFunctionTrim_3,
    PartiQLFunctionPosition,
    PartiQLFunctionOverlay_1,
    PartiQLFunctionOverlay_2,
    PartiQLFunctionExtract,
    PartiQLFunctionCardinality
)

/**
 * ABS operates on a numeric argument and returns its absolute value in the same most specific type.
 */
internal object PartiQLFunctionAbs : PartiQLFunctionUnaryNumeric("abs") {
 ...
 */
internal object PartiQLFunctionMod : PartiQLFunction {
    ...
    override fun invoke(session: ConnectorSession, arguments: List<PartiQLValue>): PartiQLValue {
        ...
        val result = x % y
        return PartiQLValue.newInt(result)
    }
}
 ...
 */
internal object PartiQLFunctionCeil : PartiQLFunctionUnaryNumeric("ceil") {
 ...
 * Returns the nearest integer greater than or equal to the input.
 */
internal object PartiQLFunctionCeiling : PartiQLFunctionUnaryNumeric("ceiling") {

    override fun call(x: Number): Number = PartiQLFunctionCeil.call(x)
}
 ...
 */
internal object PartiQLFunctionFloor : PartiQLFunctionUnaryNumeric("floor") {
 ...
 */
internal object PartiQLFunctionSqrt : PartiQLFunctionUnaryNumeric("sqrt") {
 ...
 * - exp(-Inf) is 0.0
 */
internal object PartiQLFunctionExp : PartiQLFunctionUnaryNumeric("exp") {
    override fun call(x: Number): Number = when (x) {
 ...
 */
internal object PartiQLFunctionPow : PartiQLFunctionBinaryNumeric("pow") {
 ...
 */
internal object PartiQLFunctionLn : PartiQLFunctionUnaryNumeric("ln") {
 ...
 */
internal object PartiQLFunctionLower : PartiQLFunction {
    ...
    override fun invoke(session: ConnectorSession, arguments: List<PartiQLValue>): PartiQLValue {
        ...
        return PartiQLValue.newString(result)
    }
}
 ...
 */
internal object PartiQLFunctionUpper : PartiQLFunction {
 ...
 */
internal object PartiQLFunctionBitLength : PartiQLFunctionMeasure("bit_length", BITSTRING) {

    override fun call(value: PartiQLValue): Int = PartiQLFunctionOctetLength.call(value) * 8
}
 ...
 */
internal object PartiQLFunctionCharLength : PartiQLFunctionMeasure("char_length", StaticType.TEXT) {

    override fun call(value: PartiQLValue): Int = codepointLength(value)
}
 ...
 * Same as CHAR_LENGTH
 */
internal object PartiQLFunctionCharacterLength : PartiQLFunctionMeasure("character_length", StaticType.TEXT) {

    override fun call(value: PartiQLValue): Int = codepointLength(value)
}

private fun codepointLength(value: PartiQLValue): Int {
 ...
 */
internal object PartiQLFunctionOctetLength : PartiQLFunctionMeasure("octet_length", BITSTRING) {

    override fun call(value: PartiQLValue): Int {
        val bytes = when {
...
internal abstract class PartiQLFunctionSubstring : PartiQLFunction {
    protected fun substring(target: String, startPosition: Int, quantity: Int? = null): PartiQLValue {
        val codePointCount = target.codePointCount(0, target.length)
        if (startPosition > codePointCount) {
            return PartiQLValue.newString("")
        }
        ...
        return PartiQLValue.newString(target.substring(byteIndexStart, byteIndexEnd))
    }
}
internal object PartiQLFunctionSubstring_1 : PartiQLFunctionSubstring() {
    ...
    override fun invoke(session: ConnectorSession, arguments: List<PartiQLValue>): PartiQLValue {
        ...
        if (required[1].type != PartiQLValueType.INT) {
            errNoContext(
...
internal object PartiQLFunctionSubstring_2 : PartiQLFunctionSubstring() {
 ...
 */
internal abstract class PartiQLFunctionTrim : PartiQLFunction {
    protected fun trim1Arg(sourceString: PartiQLValue): String = codepointTrim(sourceString.stringValue())
    ...
    protected fun trim2Arg(specificationOrToRemove: PartiQLValue, sourceString: PartiQLValue): String {
    ...
    protected fun trim3Arg(specification: PartiQLValue, toRemove: PartiQLValue, sourceString: PartiQLValue): String {
...
internal object PartiQLFunctionTrim_1 : PartiQLFunctionTrim() {
...
internal object PartiQLFunctionTrim_2 : PartiQLFunctionTrim() {
...
internal object PartiQLFunctionTrim_3 : PartiQLFunctionTrim() {
 ...
 */
internal object PartiQLFunctionPosition : PartiQLFunction {
 ...
 */
internal abstract class PartiQLFunctionOverlay : PartiQLFunction {
    protected fun overlay(arg0: PartiQLValue, arg1: PartiQLValue, arg2: PartiQLValue, arg3: PartiQLValue? = null): PartiQLValue {
...
internal object PartiQLFunctionOverlay_1 : PartiQLFunctionOverlay() {
...
internal object PartiQLFunctionOverlay_2 : PartiQLFunctionOverlay() {
 ...
 */
internal object PartiQLFunctionExtract : PartiQLFunction {
    ...
    override fun invoke(session: ConnectorSession, arguments: List<PartiQLValue>): PartiQLValue {
        return when {
            required[1].isUnknown() -> PartiQLValue.nullValue
            else -> eval(required)
        }
    }

    private fun eval(args: List<PartiQLValue>): PartiQLValue {
        val dateTimePart = args[0].dateTimePartValue()
        val extractedValue = when (args[1].type) {
            PartiQLValueType.TIMESTAMP -> args[1].timestampValue().extractedValue(dateTimePart)
            PartiQLValueType.DATE -> args[1].dateValue().extractedValue(dateTimePart)
            PartiQLValueType.TIME -> args[1].timeValue().extractedValue(dateTimePart)
            else -> errNoContext(
        ...
        return PartiQLValue.newDecimal(extractedValue)
    }
}
 ...
 */
internal object PartiQLFunctionCardinality : PartiQLFunction {
