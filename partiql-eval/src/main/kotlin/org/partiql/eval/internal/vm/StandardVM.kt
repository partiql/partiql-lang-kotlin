...
internal class StandardVM : PartiQLVM {
    ...
    override fun execute(plan: Plan, mode: Mode, catalogs: Array<ExecutionCatalog>): Datum {
        return execute(plan, mode, catalogs, Context.standard())
    }

    override fun execute(plan: Plan, mode: Mode, catalogs: Array<ExecutionCatalog>, ctx: Context): Datum {
        try {
