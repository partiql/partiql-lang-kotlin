...
import org.partiql.lang.eval.internal.errorContextFrom
import org.partiql.lang.eval.internal.fillErrorContext
...
internal const val MISSING_ANNOTATION = "\$missing"
internal const val BAG_ANNOTATION = "\$bag"
internal const val DATE_ANNOTATION = "\$date"
internal const val TIME_ANNOTATION = "\$time"
internal const val GRAPH_ANNOTATION = "\$graph"

/**
 * Wraps the given [ExprValue] with a delegate that provides the [OrderedBindNames] facet.
 */
internal fun ExprValue.orderedNamesValue(names: List<String>): ExprValue =
...
internal val ExprValue.orderedNames: List<String>?
    get() = asFacet(OrderedBindNames::class.java)?.orderedNames

/** Wraps this [ExprValue] as a [Named] instance. */
internal fun ExprValue.asNamed(): Named = object : Named {
...
internal val ExprValue.address: ExprValue?
    get() = asFacet(Addressed::class.java)?.address

internal fun ExprValue.booleanValue(): Boolean =
...
internal fun ExprValue.stringify(): String =
    ConfigurableExprValueFormatter.standard.format(this)

internal val DEFAULT_COMPARATOR = NaturalExprValueComparators.NULLS_FIRST_ASC

/** Provides the default equality function. */
internal fun ExprValue.exprEquals(other: ExprValue): Boolean = DEFAULT_COMPARATOR.compare(this, other) == 0
 ...
 */
internal operator fun ExprValue.compareTo(other: ExprValue): Int {
    return when {
...
internal fun Sequence<ExprValue>.multiplicities(): TreeMap<ExprValue, Int> {
