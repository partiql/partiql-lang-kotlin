...
import org.partiql.lang.eval.internal.visitors.AggregationVisitorTransform
import org.partiql.lang.eval.internal.visitors.OrderBySortSpecVisitorTransform
...
internal class PartiQLPlannerDefault(
    ...
    override fun plan(statement: PartiqlAst.Statement): PartiQLPlanner.Result {
        ...
        return PartiQLPlanner.Result.Success(
            plan = plan, warnings = problemHandler.problems, details = PartiQLPlanner.PlanningDetails(
                ast = statement,
    ...
    private fun PartiqlAst.Statement.toLogicalPlan(problems: ProblemCollector): PartiqlLogical.Plan {
        ...
        return PartiqlLogical.Plan(
            stmt = transform.transformStatement(this), version = PartiQLPlanner.PLAN_VERSION.asPrimitive()
        )
    }
