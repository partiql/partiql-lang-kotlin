    ...
    class ToStringPassCases : ArgumentsProviderBase() {
        override fun getParameters(): List<Any> = listOf(
            ...
            ExprFunctionTestCase(
                "to_string(`0500-03-09`, 'MM/dd/yyyy')",
                "\"03/09/0500\""
            ),
            ExprFunctionTestCase(
                "to_string(`0500-03-09`, 'M/d/y')",
                "\"3/9/500\""
            ),
            ExprFunctionTestCase(
                "to_string(`0001-03-09`, 'MM/dd/yyyy')",
                "\"03/09/0001\""
            ),
            ExprFunctionTestCase(
                "to_string(`0001-03-09`, 'M/d/y')",
                "\"3/9/1\""
            ),
            ExprFunctionTestCase(
                "to_string(`9999-03-09`, 'MM/dd/yyyy')",
                "\"03/09/9999\""
            ),
            ExprFunctionTestCase(
                "to_string(`9999-03-09`, 'M/d/y')",
                "\"3/9/9999\""
            ),
            ...
            ExprFunctionTestCase(
                "to_string(`9999-03-09`, missing)",
                "null",
                "$MISSING_ANNOTATION::null"
            ),
            ExprFunctionTestCase(
                "to_string(missing, 'M/d/y')",
                "null",
                "$MISSING_ANNOTATION::null"
            ),
            ExprFunctionTestCase(
            ...
            ExprFunctionTestCase(
                "to_string(`1969-07-20T20:18Z`, 'MMMM d, y h:m a')",
                "\"July 20, 1969 8:18 PM\""
            ),
            ExprFunctionTestCase(
            ...
            ExprFunctionTestCase(
                "to_string(`1969-07-20T20:18+08:00`, 'y-MM-dd''T''H:m:ssX')",
                "\"1969-07-20T20:18:00+08\""
            ),
            ExprFunctionTestCase(
