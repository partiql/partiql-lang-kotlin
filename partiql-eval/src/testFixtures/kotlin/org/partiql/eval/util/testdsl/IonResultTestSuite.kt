...
import org.partiql.eval.util.createPartiqlIonSchemaSystem
...
data class IonResultTestSuite(
    ...
    fun mockDb(): MockDb =
        MockDb(globals, createPartiqlIonSchemaSystem(ION))
}
 ...
 */
fun defineTestSuite(block: SuiteBuilder.() -> Unit): IonResultTestSuite =
