...
class QueryDDB(private val ion: IonSystem) : PartiQLFunction {
    ...
    override val signature = Signature(
        names = listOf("query_ddb"),
        parameters = listOf(Parameter.ValueParameter(name = "str", type = PartiQLValueType.STRING)),
    ...
    override fun invoke(session: ConnectorSession, required: List<PartiQLValue>): PartiQLValue {
        initializeClient()
