...
public abstract class SqlConnector : Connector {
     ...
     * @return
     */
    abstract override fun getMetadata(session: ConnectorSession): org.partiql.planner.internal.fn.sql.SqlMetadata

    override fun getBindings(): ConnectorBindings = org.partiql.planner.internal.fn.sql.SqlBindings(info)

    @FnExperimental
    override fun getFunctions(): ConnectorFnProvider = org.partiql.planner.internal.fn.sql.SqlFnProvider(info.functions)

    @FnExperimental
    override fun getAggregations(): ConnectorAggProvider =
        org.partiql.planner.internal.fn.sql.SqlAggProvider(info.aggregations)
}
