...
import org.partiql.planner.internal.connector.ConnectorPath
...
public interface Index<T> {
    ...
    public abstract class Builder<T> {
        ...
        public class Fn : Builder<org.partiql.planner.internal.fn.Fn>() {
            override fun build(): Index<org.partiql.planner.internal.fn.Fn> {
                val fns = builtins
        ...
        public class Agg : Builder<org.partiql.planner.internal.fn.Agg>() {
            override fun build(): Index<org.partiql.planner.internal.fn.Agg> {
                val fns = builtins
                    .groupBy { it.signature.name.uppercase() }
                    .mapValues { e -> e.value.associateBy { f -> f.signature.specific } }
                return IndexMap(fns)
