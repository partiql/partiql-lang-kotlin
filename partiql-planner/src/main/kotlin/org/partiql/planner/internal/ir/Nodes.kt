...
internal sealed class Ref : PlanNode() {
  ...
  internal data class Cast(
    @JvmField
    internal val input: CompilerType,
    @JvmField
    internal val target: CompilerType,
    @JvmField
    internal val safety: Safety,
    @JvmField
  ...
  internal sealed class Op : PlanNode() {
    ...
    internal sealed class Set : Op() {
      ...
      internal data class Union(
        @JvmField
        internal val quantifier: Quantifier,
        @JvmField
