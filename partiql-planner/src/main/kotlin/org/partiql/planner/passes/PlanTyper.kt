...
// import org.partiql.plan.PlanPass
...
//
// /**
//  * Schema represents the output type of a relational operator
//  */
// private typealias Schema = List<Rel.Binding>
//
// /**
...
//     }
//
//     private inner class Visitor : PlanRewriter<Unit>() {
//
...
//         //
//
//         override fun visitRelOpBag(node: Rel.Op.Bag, ctx: Context): PlanNode {
//             TODO("BAG OPERATORS are not supported by the PartiQLTypeEnvInferencer yet.")
//         }
//
//         override fun visitRelOpJoin(node: Rel.Op.Join, ctx: Context): Rel.Op.Join {
//             val lhs = visitRelOp(node.lhs, ctx)
...
//         }
//
//         override fun visitRelOpUnpivot(node: Rel.Op.Unpivot, ctx: Context): Rel.Op.Unpivot {
//             val from = node
//
...
//         }
//
//         override fun visitRelOpAggregate(node: Rel.Op.Aggregate, ctx: Context): PlanNode {
//             val input = visitRelOp(node.input, ctx)
...
//         }
//
//         override fun visitRelOpProject(node: Rel.Op.Project, ctx: Context): PlanNode {
//             val input = visitRelOp(node.input, ctx)
...
//         }
//
//         override fun visitRelOpScan(node: Rel.Op.Scan, ctx: Context): Rel {
//             val value = visitRex(
//                 node.value,
//                 Context(
//                     ctx.input,
...
//         }
//
//         override fun visitRelOpFilter(node: Rel.Op.Filter, ctx: Context): PlanNode {
//             val input = visitRelOp(node.input, ctx)
...
//         }
//
//         override fun visitRelOpSort(node: Rel.Op.Sort, ctx: Context): PlanNode {
//             val input = visitRelOp(node.input, ctx)
//             return node.copy(
//                 input = input,
//                 common = node.common.copy(
...
//         }
//
//         override fun visitRelOpFetch(node: Rel.Op.Fetch, ctx: Context): PlanNode {
...
//     }
//
//     private inner class RelTyper : PlanBaseVisitor<Schema>
//
//     //
//     //
//     // EXPRESSIONS
...
//     //     }
//     //
//     // private fun Rel.Op.getTypeEnv() = PlanUtils.getTypeEnv(this)
//     //
//     // private fun Rel.Op.getProperties() = this.getCommon().properties
//     //
//     // private fun Rel.Op.getCommon() = when (this) {
//     //     is Rel.Op.Aggregate -> this.common
//     //     is Rel.Op.Bag -> this.common
//     //     is Rel.Op.Fetch -> this.common
//     //     is Rel.Op.Filter -> this.common
//     //     is Rel.Op.Join -> this.common
//     //     is Rel.Op.Project -> this.common
//     //     is Rel.Op.Scan -> this.common
//     //     is Rel.Op.Sort -> this.common
//     //     is Rel.Op.Unpivot -> this.common
//     // }
//     //
