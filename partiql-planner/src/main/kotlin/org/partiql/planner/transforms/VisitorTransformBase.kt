...
import org.partiql.planner.impl.checkThreadInterrupted
 ...
 */
public abstract class VisitorTransformBase : PartiqlAst.VisitorTransform() {
     ...
     * infinite recursion.
     */
    public fun transformExprSelectEvaluationOrder(node: PartiqlAst.Expr.Select): PartiqlAst.Expr {
     ...
     * infinite recursion.
     */
    public fun transformDataManipulationEvaluationOrder(node: PartiqlAst.Statement.Dml): PartiqlAst.Statement {
