...
- There is no EvaluatorOptions equivalent for CompileOptions.thunkReturnTypeAssertions since PlannerPipeline support
the static type inferencer (yet)
- PlannerOptions.allowUndefinedVariables (might) be new
