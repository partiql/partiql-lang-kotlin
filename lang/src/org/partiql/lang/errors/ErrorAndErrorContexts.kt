...
enum class Property(val propertyName: String, val propertyType: PropertyType) {
    ...
    ARGUMENT_POSITION("argument_position", INTEGER_CLASS),
    NARY_OP("nary_op", STRING_CLASS),
    ...
    INT_SIZE_IN_BYTES("INT_SIZE", INTEGER_CLASS),
    EXPECTED_STATIC_TYPE("EXPECTED_STATIC_TYPE", STRING_CLASS),
    CONSTANT("CONSTANT", STRING_CLASS),
    MESSAGE("MESSAGE", STRING_CLASS)
}
