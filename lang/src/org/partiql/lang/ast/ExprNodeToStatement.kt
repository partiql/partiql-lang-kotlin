...
fun DataType.toAstType(): PartiqlAst.Type {
    ...
    return PartiqlAst.build {
        when (thiz.sqlDataType) {
            ...
            SqlDataType.DATE,
            SqlDataType.DOUBLE_PRECISION -> scalarType(thiz.alias, metas = metas)
            SqlDataType.TIME,
            SqlDataType.TIME_WITH_TIME_ZONE,
            SqlDataType.FLOAT,
            SqlDataType.CHARACTER,
            SqlDataType.CHARACTER_VARYING -> scalarType(thiz.alias, listOfNotNull(arg1), metas)
            SqlDataType.DECIMAL,
            SqlDataType.NUMERIC -> scalarType(thiz.alias, listOfNotNull(arg1, arg2), metas)
