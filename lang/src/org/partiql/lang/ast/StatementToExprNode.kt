    ...
    private fun PartiqlAst.Type.toExprNodeType(): DataType {
        ...
        return when (this) {
            ...
            is PartiqlAst.Type.ScalarType -> when (id.text) {
                ...
                BuiltInScalarTypeId.FLOAT -> DataType(SqlDataType.FLOAT, listOfNotNull(parameters[0].longValueOrNull?.toIntExact()), metas)
                ...
                BuiltInScalarTypeId.DECIMAL -> DataType(SqlDataType.DECIMAL, listOfNotNull(parameters[0].longValueOrNull?.toIntExact(), parameters[1].longValueOrNull?.toIntExact()), metas)
                BuiltInScalarTypeId.NUMERIC -> DataType(SqlDataType.NUMERIC, listOfNotNull(parameters[0].longValueOrNull?.toIntExact(), parameters[1].longValueOrNull?.toIntExact()), metas)
                BuiltInScalarTypeId.TIMESTAMP -> DataType(SqlDataType.TIMESTAMP, listOf(), metas)
                BuiltInScalarTypeId.CHARACTER -> DataType(SqlDataType.CHARACTER, listOfNotNull(parameters[0].longValueOrNull?.toIntExact()), metas)
                BuiltInScalarTypeId.CHARACTER_VARYING -> DataType(SqlDataType.CHARACTER_VARYING, listOfNotNull(parameters[0].longValueOrNull?.toIntExact()), metas)
                ...
                BuiltInScalarTypeId.TIME -> DataType(SqlDataType.TIME, listOfNotNull(parameters[0].longValueOrNull?.toIntExact()), metas)
                BuiltInScalarTypeId.TIME_WITH_TIME_ZONE -> DataType(SqlDataType.TIME_WITH_TIME_ZONE, listOfNotNull(parameters[0].longValueOrNull?.toIntExact()), metas)
