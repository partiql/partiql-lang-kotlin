...
class StaticTypeInferencer(
    ...
    fun inferStaticType(node: PartiqlAst.Statement): InferenceResult {
        ...
        val inferencer = StaticTypeInferenceVisitorTransform(globalBindings, customFunctionSignatures, customTypedOpParameters, problemCollector, scalarTypeSystem = scalarTypeSystem)
