...
fun PartiqlAst.Type.toTypedOpParameter(customTypedOpParameters: Map<String, TypedOpParameter>, aliasToScalarType: Map<String, ScalarType>): TypedOpParameter {
    ...
    return physicalType.toTypedOpParameter(customTypedOpParameters, aliasToScalarType)
}
