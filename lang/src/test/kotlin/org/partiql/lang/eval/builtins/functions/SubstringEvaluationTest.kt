...
class SubstringEvaluationTest : EvaluatorTestBase() {
    ...
    class SubstringPassCases : ArgumentsProviderBase() {
        override fun getParameters(): List<Any> = listOf(
            ...
            ExprFunctionTestCase("substring(missing FROM 1)", "NULL", "MISSING"),
            ExprFunctionTestCase("substring('abc' FROM missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("substring(missing FROM 1 FOR 1)", "NULL", "MISSING"),
            ExprFunctionTestCase("substring('abc' FROM missing FOR 1)", "NULL", "MISSING"),
            ...
            ExprFunctionTestCase("substring(missing, 1)", "NULL", "MISSING"),
            ExprFunctionTestCase("substring('abc', missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("substring(missing, 1, 1)", "NULL", "MISSING"),
            ExprFunctionTestCase("substring('abc', missing, 1)", "NULL", "MISSING"),
            ExprFunctionTestCase("substring('abc', 1, missing)", "NULL", "MISSING"),
