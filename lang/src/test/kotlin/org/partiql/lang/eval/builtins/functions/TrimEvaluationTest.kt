...
class TrimEvaluationTest : EvaluatorTestBase() {
    ...
    class CharLengthPassCases : ArgumentsProviderBase() {
        override fun getParameters(): List<Any> = listOf(
            ...
            ExprFunctionTestCase("trim(both missing from '')", "NULL", "MISSING"),
            ExprFunctionTestCase("trim(both '' from missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("trim(missing from '')", "NULL", "MISSING"),
            ExprFunctionTestCase("trim('' from missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("trim(missing)", "NULL", "MISSING"),
