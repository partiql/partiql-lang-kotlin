...
class ExtractEvaluationTest : EvaluatorTestBase() {
    ...
    class ExtractPassCases : ArgumentsProviderBase() {
        override fun getParameters(): List<Any> = listOf(
            ...
            ExprFunctionTestCase("extract(year FROM missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("extract(month FROM missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("extract(day FROM missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("extract(hour FROM missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("extract(minute FROM missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("extract(second FROM missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("extract(timezone_hour FROM missing)", "NULL", "MISSING"),
            ExprFunctionTestCase("extract(timezone_minute FROM missing)", "NULL", "MISSING"),
