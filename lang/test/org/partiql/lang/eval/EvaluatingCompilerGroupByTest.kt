    ...
    fun parametersForSql92StyleAggregatesTest() =
        createAggregateTestCasesFromSqlStrings(
            ...
            createAggregateTestCasesFromSqlTemplates(
                ...
                expectedResultForSum = "<< { 'the_count': 10, 'the_agg': 15.0 } >>",
                expectedResultForMin = "<< { 'the_count': 10, 'the_agg': 1.0 } >>",
                expectedResultForMax = "<< { 'the_count': 10, 'the_agg': 5.0 } >>",
                expectedResultForAvg = "<< { 'the_count': 10, 'the_agg': 3.0 } >>"
            ) +
            createAggregateTestCasesFromSqlTemplates(
                ...
                >>""",
                expectedResultForSum = """<<
                { 'categoryId': 20, 'the_count': 4, 'the_agg': 6.0 },
                { 'categoryId': 21, 'the_count': 6, 'the_agg': 9.0 }
                >>""",
                expectedResultForMin = """<<
                { 'categoryId': 20, 'the_count': 4, 'the_agg': 1.0 },
                { 'categoryId': 21, 'the_count': 6, 'the_agg': 4.0 }
                >>""",
                expectedResultForMax = """<<
                { 'categoryId': 20, 'the_count': 4, 'the_agg': 3.0 },
                { 'categoryId': 21, 'the_count': 6, 'the_agg': 5.0 }
                >>""",
                expectedResultForAvg = """<<
                { 'categoryId': 20, 'the_count': 4, 'the_agg': 2.0 },
                ...
                """<<
                        {
                            ...
                            'g':
                                <<
                                    ...
                                    { 'simple_1_col_1_group': { 'col1': 1 }, 'different_types_per_row': 1002.0 },
