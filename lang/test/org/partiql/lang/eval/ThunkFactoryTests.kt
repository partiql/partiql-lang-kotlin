...
class ThunkFactoryTests {
    ...
    companion object {
        ...
        private val STRING_SHORT = stringExprValue("Hello, I'm a string")
        private val STRING_LONG = stringExprValue("Hello, I'm a loooooooooooooooooooooooooooooooooooong string!")
        private val INT_42 = intExprValue(42)
        private val INT_42000 = intExprValue(42000)
        private val IRRELEVANT = stringExprValue("doesn't matter")
    ...
    internal fun thunkEnvValueUnexpectedReturnType(tc: TestCase) =
        assertInvoke(tc.expectError) {
            tc.thunkFactory.thunkEnvValue(tc.metas) { _, _ ->
                tc.thunkReturnValue
            }.invoke(Environment.standard(), stringExprValue("doesn't matter"))
        }
