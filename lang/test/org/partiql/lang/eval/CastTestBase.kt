    ...
    companion object : EvaluatorTestBase() {
        ...
        private val commonDateTimeTests = listOf(
            ...
            listOf(
                ...
                case("TIME '23:12:12.1267-05:30'", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.1267${defaultTimezoneOffset.getOffsetHHmm()}'", CastQuality.LOSSLESS),
                case("TIME '23:12:12.1267+05:30'", "TIME (3)", "TIME '23:12:12.127'", CastQuality.LOSSY),
                case("TIME '23:12:12.1267-05:30'", "TIME (3) WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.127${defaultTimezoneOffset.getOffsetHHmm()}'", CastQuality.LOSSY),
                ...
                case("TIME (3) '23:12:12.1267+05:30'", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.127${defaultTimezoneOffset.getOffsetHHmm()}'", CastQuality.LOSSLESS),
                ...
                case("TIME WITH TIME ZONE '23:12:12.1267+05:30'", "TIME (3) WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.127+05:30'", CastQuality.LOSSY),
                ...
                case("TIME (3) WITH TIME ZONE '23:12:12.1267-05:30'", "TIME (5) WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.12700-05:30'", CastQuality.LOSSLESS),
                ...
                case("`2007-02-23T12:14:33.079Z`", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '12:14:33.079+00:00'", CastQuality.LOSSY),
                case("`2007-02-23T12:14:33.079-08:00`", "TIME (1)", "TIME '12:14:33.1'", CastQuality.LOSSY),
                case("`2007-02-23T12:14:33.079-08:00`", "TIME (2) WITH TIME ZONE", "TIME WITH TIME ZONE '12:14:33.08-08:00'", CastQuality.LOSSY),
                ...
                case("'23:12:12.1267'", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.1267${defaultTimezoneOffset.getOffsetHHmm()}'", CastQuality.LOSSY),
                case("'23:12:12.1267'", "TIME (2) WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.13${defaultTimezoneOffset.getOffsetHHmm()}'", CastQuality.LOSSY),
                case("""`"23:12:12.1267"`""", "TIME", "TIME '23:12:12.1267'", CastQuality.LOSSLESS),
                case("""`"23:12:12.1267"`""", "TIME (2)", "TIME '23:12:12.13'", CastQuality.LOSSY),
                case("""`"23:12:12.1267"`""", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.1267${defaultTimezoneOffset.getOffsetHHmm()}'", CastQuality.LOSSY),
                case("""`'23:12:12.1267'`""", "TIME (2) WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.13${defaultTimezoneOffset.getOffsetHHmm()}'", CastQuality.LOSSY),
        ...
        private val castDefaultTimezoneOffsetConfiguration =
            ...
            listOf(
                ...
                Pair(case("TIME '23:12:12.1267'", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.1267+00:00'", CastQuality.LOSSLESS), createZoneOffset()),
                ...
                Pair(case("`2007-02-23T12:14:33.079Z`", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '12:14:33.079+00:00'", CastQuality.LOSSY), createZoneOffset()),
                Pair(case("`2007-02-23T12:14:33.079Z`", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '12:14:33.079+00:00'", CastQuality.LOSSY), createZoneOffset(11)),
                ...
                Pair(case("`2007-02-23T12:14:33.079Z`", "TIME (2) WITH TIME ZONE", "TIME WITH TIME ZONE '12:14:33.08+00:00'", CastQuality.LOSSY), createZoneOffset(-5, -30)),
                // CAST(<text> AS <TIME WITH TIME ZONE>)
                Pair(case("'23:12:12.1267'", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.1267+00:00'", CastQuality.LOSSY), createZoneOffset()),
                ...
                Pair(case("'23:12:12.1267'", "TIME (2) WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.13-05:30'", CastQuality.LOSSY), createZoneOffset(-5, -30)),
                Pair(case("""`'23:12:12.1267'`""", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.1267+00:00'", CastQuality.LOSSY), createZoneOffset()),
                Pair(case("""`'23:12:12.1267'`""", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.1267+11:00'", CastQuality.LOSSY), createZoneOffset(11)),
                Pair(case("""`'23:12:12.1267'`""", "TIME (2) WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.13-05:30'", CastQuality.LOSSY), createZoneOffset(-5, -30)),
                Pair(case("""`"23:12:12.1267"`""", "TIME WITH TIME ZONE", "TIME WITH TIME ZONE '23:12:12.1267+00:00'", CastQuality.LOSSY), createZoneOffset()),
