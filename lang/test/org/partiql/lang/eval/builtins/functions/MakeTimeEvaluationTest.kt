...
class MakeTimeEvaluationTest : EvaluatorTestBase() {
    ...
    class MakeTimePassCases : ArgumentsProviderBase() {
        override fun getParameters(): List<Any> = listOf(
            ...
            ExprFunctionTestCase("make_time(0, 0, 0., 0)", "TIME '00:00:00+00:00'"),
            ExprFunctionTestCase("make_time(23, 12, 59.12345)", "TIME '23:12:59.12345'"),
            ExprFunctionTestCase("make_time(23, 12, 59.12345, 800)", "TIME '23:12:59.12345+13:20'"),
            ExprFunctionTestCase("make_time(23, 59, 59.999999999)", "TIME '23:59:59.999999999'"),
            ExprFunctionTestCase("make_time(23, 12, 59.12345, -800)", "TIME '23:12:59.12345-13:20'"),
            ExprFunctionTestCase("make_time(23, 59, 59.999999999, -1080)", "TIME '23:59:59.999999999-18:00'"),
            ExprFunctionTestCase("make_time(23, 59, 59.999999999, 1080)", "TIME '23:59:59.999999999+18:00'"),
            ExprFunctionTestCase("make_time(`23`, `12`, `59.12345`, `800`)", "TIME '23:12:59.12345+13:20'"),
