 ...
 */
public interface RexGlobal : Rex {
    ...
    override fun <R, C> accept(visitor: RexVisitor<R, C>, ctx: C): R = visitor.visitGlobal(this, ctx)

    /**
     * Default [RexGlobal] implementation.
     */
    abstract class Base(catalog: String, name: String) : RexGlobal {
