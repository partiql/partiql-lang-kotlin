...
class RunnerTest {
    ...
    fun successTestExample(tc: SuccessTestProvider.ExampleTestCase, result: ExprValue) {
    ...
    fun complexTestExample(tc: SimpleTestCase, result: ExprValue) {
        assertEquals(ExprValueType.BAG, result.type)
