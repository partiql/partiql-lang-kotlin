...
class ConformanceTestEval : ConformanceTestBase<PartiQLStatement<*>, PartiQLResult>() {
    ...
    override val skipListForEvaluation: Set<Pair<String, CompileOptions>> = getSkipList("/config/eval/skip-eval.txt")

    override val skipListForEquivalence: Set<Pair<String, CompileOptions>> = getSkipList("/config/eval/skip-eval-equiv.txt")
}
