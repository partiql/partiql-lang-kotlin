...
class DatumWriterTextPrettyTests {
    companion object {
        ...
        <<
          ...
          INTERVAL '-0-5' YEAR (2) TO MONTH,
          INTERVAL '-0 5' DAY (2) TO HOUR,
          INTERVAL '-0 0:5' DAY (2) TO MINUTE,
          INTERVAL '-0 0:0:5.50' DAY (2) TO SECOND (2),
          INTERVAL '-0 0:0:0.50' DAY (2) TO SECOND (2),
          INTERVAL '-0:5' HOUR (2) TO MINUTE,
          INTERVAL '-0:0:5.50' HOUR (2) TO SECOND (2),
          INTERVAL '-0:0:0.50' HOUR (2) TO SECOND (2),
          INTERVAL '-0:5.50' MINUTE (2) TO SECOND (2),
          INTERVAL '-0:0.50' MINUTE (2) TO SECOND (2),
          INTERVAL '99' MONTH (2),
          INTERVAL '99' HOUR (2),
          INTERVAL '99' MINUTE (2),
          INTERVAL '99.00' SECOND (2, 2),
          INTERVAL '-99.00' SECOND (2, 2),
          INTERVAL '99:1.00' MINUTE (2) TO SECOND (2),
          INTERVAL '99:1:2.00' HOUR (2) TO SECOND (2),
          INTERVAL '99:1' HOUR (2) TO MINUTE,
          INTERVAL '99:1:2.00' HOUR (2) TO SECOND (2),
        ...
        val data = Datum.bagVararg(
            ...
            // Zero leading field
            Datum.intervalYearMonth(0, -5, 2),
            Datum.intervalDayHour(0, -5, 2),
            Datum.intervalDayMinute(0, 0, -5, 2),
            Datum.intervalDaySecond(0, 0, 0, -5, -500000000, 2, 2),
            Datum.intervalDaySecond(0, 0, 0, 0, -500000000, 2, 2),
            Datum.intervalHourMinute(0, -5, 2),
            Datum.intervalHourSecond(0, 0, -5, -500000000, 2, 2),
            Datum.intervalHourSecond(0, 0, 0, -500000000, 2, 2),
            Datum.intervalMinuteSecond(0, -5, -500000000, 2, 2),
            Datum.intervalMinuteSecond(0, 0, -500000000, 2, 2),
            // Value greater than field divisor
            Datum.intervalMonth(99, 2),
            Datum.intervalHour(99, 2),
            Datum.intervalMinute(99, 2),
            Datum.intervalSecond(99, 0, 2, 2),
            Datum.intervalSecond(-99, 1, 2, 2),
            Datum.intervalMinuteSecond(99, 1, 0, 2, 2),
            Datum.intervalHourSecond(99, 1, 2, 0, 2, 2),
            Datum.intervalHourMinute(99, 1, 2),
            Datum.intervalHourSecond(99, 1, 2, 3, 2, 2),
