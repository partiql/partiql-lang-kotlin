...
/**
 * Created by therapon on 7/25/17.
 */
interface IErrorHandler {
    /**
     * Called to handle an error in the IonSQL++ **evaluator** from which we may recover.
     * The call passes the [ErrorCode] and context about the error as a [PropertyBag].
     *
     ...
     */
    fun  handle(errorCode: ErrorCode, context: PropertyBag) : ExprValue
