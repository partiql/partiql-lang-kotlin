...
import com.amazon.ionsql.util.codePointSequence
 ...
 * This state is terminal-- has not outgoing transitions and it is neither a start State nor a Final state
 */
 ...
 *
 * PRE-CONDITION: [pattern] is a valid SQL LIKE pattern, i.e, the result of `checkPattern` function
 *
 *
...
/**
 * Given the sequence of NFA letters  that correspond to the search string and the search strigns length
...
private fun buildNfa(letters: Sequence<Alphabet>, patternSize: Int): NFAState =
    letters.foldIndexed(mutableListOf(NFAState(-1, 0 == (patternSize - 1), true)), { index, acc, transition ->
