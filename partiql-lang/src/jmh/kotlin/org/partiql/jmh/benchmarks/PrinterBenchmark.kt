...
/**
 * This test is a copy of `ParserBenchmark`, but benchmarks the pretty-printer.
 */
@BenchmarkMode(Mode.AverageTime)
@OutputTimeUnit(TimeUnit.MICROSECONDS)
internal open class PrinterBenchmark {
    ...
    fun parseNameQuerySimple(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::querySimple.name]!!)
        val str = ast.root.sql()
    ...
    fun parseNameNestedParen(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::nestedParen.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameSomeJoins(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::someJoins.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameSeveralJoins(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::severalJoins.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameSomeSelect(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::someSelect.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameSeveralSelect(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::severalSelect.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameSomeProjections(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::someProjections.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameSeveralProjections(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::severalProjections.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameQueryFunc(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::queryFunc.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameQueryFuncInProjection(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::queryFuncInProjection.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameQueryList(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::queryList.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameQuery15OrsAndLikes(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::query15OrsAndLikes.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameQuery30Plus(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::query30Plus.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameQueryNestedSelect(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::queryNestedSelect.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameGraphPattern(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::graphPattern.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameGraphPreFilters(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::graphPreFilters.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameManyJoins(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::manyJoins.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameTimeZone(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::timeZone.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameCaseWhenThen(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::caseWhenThen.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameSimpleInsert(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::simpleInsert.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameExceptUnionIntersectSixty(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::exceptUnionIntersectSixty.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameExec20Expressions(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::exec20Expressions.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameFromLet(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::fromLet.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameGroupLimit(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::groupLimit.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNamePivot(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::pivot.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameLongFromSourceOrderBy(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::longFromSourceOrderBy.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameNestedAggregates(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::nestedAggregates.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameComplexQuery(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::complexQuery.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameComplexQuery01(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::complexQuery01.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameComplexQuery02(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::complexQuery02.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameVeryLongQuery(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::veryLongQuery.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseNameVeryLongQuery01(state: MyState, blackhole: Blackhole) {
        val ast = state.parser.parse(state.queries[state::veryLongQuery01.name]!!)
        val str = ast.root.sql()
        blackhole.consume(str)
    }
    ...
    fun parseFailNameQuerySimple(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::querySimple.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
    ...
    fun parseFailNameNestedParen(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::nestedParen.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameSomeJoins(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::someJoins.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameSeveralJoins(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::severalJoins.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameSomeSelect(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::someSelect.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameSeveralSelect(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::severalSelect.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameSomeProjections(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::someProjections.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameSeveralProjections(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::severalProjections.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameQueryFunc(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::queryFunc.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameQueryFuncInProjection(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::queryFuncInProjection.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameQueryList(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::queryList.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameQuery15OrsAndLikes(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::query15OrsAndLikes.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameQuery30Plus(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::query30Plus.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameQueryNestedSelect(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::queryNestedSelect.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameGraphPattern(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::graphPattern.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameGraphPreFilters(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::graphPreFilters.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameManyJoins(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::manyJoins.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameTimeZone(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::timeZone.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameCaseWhenThen(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::caseWhenThen.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameSimpleInsert(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::simpleInsert.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameExceptUnionIntersectSixty(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::exceptUnionIntersectSixty.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameExec20Expressions(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::exec20Expressions.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameFromLet(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::fromLet.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameGroupLimit(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::groupLimit.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNamePivot(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::pivot.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameLongFromSourceOrderBy(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::longFromSourceOrderBy.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameNestedAggregates(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::nestedAggregates.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameComplexQuery(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::complexQuery.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameComplexQuery01(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::complexQuery01.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameComplexQuery02(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::complexQuery02.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameVeryLongQuery(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::veryLongQuery.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    fun parseFailNameVeryLongQuery01(state: MyState, blackhole: Blackhole) {
        try {
            val ast = state.parser.parse(state.queriesFail[state::veryLongQuery01.name]!!)
            val str = ast.root.sql()
            blackhole.consume(str)
            throw RuntimeException()
        } catch (ex: ParserException) {
    ...
    open class MyState {
        ...
        val groupLimit = "SELECT g FROM `[{foo: 1, bar: 10}, {foo: 1, bar: 11}]` AS f GROUP BY f.foo GROUP AS g LIMIT 1"
