...
internal open class PartiQLParserBenchmark {
    ...
    fun parseNameQuerySimple(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::querySimple.name]!!)
    ...
    fun parseNameNestedParen(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::nestedParen.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameSomeJoins(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::someJoins.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameSeveralJoins(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::severalJoins.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameSomeSelect(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::someSelect.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameSeveralSelect(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::severalSelect.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameSomeProjections(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::someProjections.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameSeveralProjections(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::severalProjections.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameQueryFunc(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::queryFunc.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameQueryFuncInProjection(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::queryFuncInProjection.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameQueryList(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::queryList.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameQuery15OrsAndLikes(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::query15OrsAndLikes.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameQuery30Plus(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::query30Plus.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameQueryNestedSelect(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::queryNestedSelect.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameGraphPattern(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::graphPattern.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameGraphPreFilters(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::graphPreFilters.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameManyJoins(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::manyJoins.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameTimeZone(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::timeZone.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameCaseWhenThen(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::caseWhenThen.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameSimpleInsert(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::simpleInsert.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameExceptUnionIntersectSixty(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::exceptUnionIntersectSixty.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameExec20Expressions(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::exec20Expressions.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameFromLet(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::fromLet.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameGroupLimit(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::groupLimit.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNamePivot(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::pivot.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameLongFromSourceOrderBy(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::longFromSourceOrderBy.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameNestedAggregates(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::nestedAggregates.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameComplexQuery(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::complexQuery.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameComplexQuery01(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::complexQuery01.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameComplexQuery02(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::complexQuery02.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameVeryLongQuery(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::veryLongQuery.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseNameVeryLongQuery01(state: MyState, blackhole: Blackhole) {
        val result = state.parser.parse(state.queries[state::veryLongQuery01.name]!!)
        blackhole.consume(result)
    }
    ...
    fun parseFailNameQuerySimple(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::querySimple.name]!!)
            blackhole.consume(result)
    ...
    fun parseFailNameNestedParen(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::nestedParen.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameSomeJoins(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::someJoins.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameSeveralJoins(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::severalJoins.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameSomeSelect(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::someSelect.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameSeveralSelect(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::severalSelect.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameSomeProjections(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::someProjections.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameSeveralProjections(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::severalProjections.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameQueryFunc(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::queryFunc.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameQueryFuncInProjection(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::queryFuncInProjection.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameQueryList(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::queryList.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameQuery15OrsAndLikes(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::query15OrsAndLikes.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameQuery30Plus(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::query30Plus.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameQueryNestedSelect(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::queryNestedSelect.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameGraphPattern(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::graphPattern.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameGraphPreFilters(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::graphPreFilters.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameManyJoins(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::manyJoins.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameTimeZone(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::timeZone.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameCaseWhenThen(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::caseWhenThen.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameSimpleInsert(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::simpleInsert.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameExceptUnionIntersectSixty(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::exceptUnionIntersectSixty.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameExec20Expressions(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::exec20Expressions.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameFromLet(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::fromLet.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameGroupLimit(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::groupLimit.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNamePivot(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::pivot.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameLongFromSourceOrderBy(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::longFromSourceOrderBy.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameNestedAggregates(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::nestedAggregates.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameComplexQuery(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::complexQuery.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameComplexQuery01(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::complexQuery01.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameComplexQuery02(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::complexQuery02.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameVeryLongQuery(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::veryLongQuery.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
    ...
    fun parseFailNameVeryLongQuery01(state: MyState, blackhole: Blackhole) {
        try {
            val result = state.parser.parse(state.queriesFail[state::veryLongQuery01.name]!!)
            blackhole.consume(result)
            throw RuntimeException()
        } catch (ex: PartiQLParserException) {
            blackhole.consume(ex)
