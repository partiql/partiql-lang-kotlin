...
import org.partiql.lang.eval.evaluatortestframework.AbstractPipeline
import org.partiql.lang.eval.evaluatortestframework.EvaluatorTestDefinition
import org.partiql.lang.eval.evaluatortestframework.EvaluatorTestTarget
import org.partiql.lang.eval.evaluatortestframework.PipelineFactory
import org.partiql.lang.eval.evaluatortestframework.createCompilerPipeline
        ...
        return object : AbstractPipeline {
            ...
            override fun evaluate(query: String): ExprValue {
                ...
                return when (val result = statement.eval(session)) {
                    ...
                    -> error("DML is not supported by test suite")
