...
class DateAddEvaluationTest : EvaluatorTestBase() {
    ...
    class DateAddPassCases : ArgumentsProviderBase() {
        ...
        private val ionTestCases = listOf(
            ...
            ExprFunctionTestCase("date_add(decimalSecond, null, `2017-01-10T05:30:55Z`)", "null"),
            ExprFunctionTestCase("date_add(decimalSecond, 1, null)", "null"),
            ExprFunctionTestCase("date_add(decimalSecond, missing, `2017-01-10T05:30:55Z`)", "null", "MISSING"),
            ExprFunctionTestCase("date_add(decimalSecond, 1, missing)", "null", "MISSING"),
            ExprFunctionTestCase("date_add(year, `1`, `2017T`)", "TIMESTAMP '2018-01-01T00:00:00-00:00'"),
            ExprFunctionTestCase(
                "date_add(decimalSecond, a, b)",
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, `2017T`)", "TIMESTAMP '2017-01-01T00:00:01-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, `2017-01T`)", "TIMESTAMP '2017-01-01T00:00:01-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, `2017-01-02T`)", "TIMESTAMP '2017-01-02T00:00:01-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, `2017-01-02T03:04Z`)", "TIMESTAMP '2017-01-02T03:04:01+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, `2017-01-02T03:04:05Z`)", "TIMESTAMP '2017-01-02T03:04:06+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, `2017-01-02T03:04:05.006Z`)", "TIMESTAMP '2017-01-02T03:04:06.006+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, ${31 * 24 * 60 * 60}, `2017-01T`)", "TIMESTAMP '2017-02-01T00:00:00-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, ${24 * 60 * 60}, `2017-02-03T`)", "TIMESTAMP '2017-02-04T00:00:00-00:00'"),

            // add enough to flip the hour
            ExprFunctionTestCase("date_add(minute, 60, `2017-02-04T05:06Z`)", "TIMESTAMP '2017-02-04T06:06:00+00:00'"),
            ExprFunctionTestCase("date_add(decimalSecond, ${60 * 60}, `2017-02-04T05:06Z`)", "TIMESTAMP '2017-02-04T06:06:00+00:00'"),

            // add enough to flip the minute
            ExprFunctionTestCase("date_add(decimalSecond, 60, `2017-02-04T05:06Z`)", "TIMESTAMP '2017-02-04T05:07:00+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, `2017T`)", "TIMESTAMP '2016-12-31T23:59:59-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, `2017-02T`)", "TIMESTAMP '2017-01-31T23:59:59-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, `2017-02-03T`)", "TIMESTAMP '2017-02-02T23:59:59-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, `2017-02-03T04:05Z`)", "TIMESTAMP '2017-02-03T04:04:59+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, `2017-02-03T04:05:06Z`)", "TIMESTAMP '2017-02-03T04:05:05+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, `2017-02-03T04:05:06.007Z`)", "TIMESTAMP '2017-02-03T04:05:05.007+00:00'")
        )

        private val partiQLTimestampWithTimeZone = listOf(
            ExprFunctionTestCase("date_add(decimalSecond, null, TIMESTAMP '2017-01-10T05:30:55Z')", "null"),
            ExprFunctionTestCase("date_add(decimalSecond, 1, null)", "null"),
            ExprFunctionTestCase("date_add(decimalSecond, missing, TIMESTAMP '2017-01-10T05:30:55Z')", "null", "MISSING"),
            ExprFunctionTestCase("date_add(decimalSecond, 1, missing)", "null", "MISSING"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, TIMESTAMP '2017-01-01T00:00:00-00:00')", "TIMESTAMP '2017-01-01T00:00:01-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, TIMESTAMP '2017-01-02T00:00:00-00:00')", "TIMESTAMP '2017-01-02T00:00:01-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, TIMESTAMP '2017-01-02T03:04:00Z')", "TIMESTAMP '2017-01-02T03:04:01+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, TIMESTAMP '2017-01-02T03:04:05Z')", "TIMESTAMP '2017-01-02T03:04:06+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, TIMESTAMP '2017-01-02T03:04:05.006Z')", "TIMESTAMP '2017-01-02T03:04:06.006+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, ${31 * 24 * 60 * 60}, TIMESTAMP '2017-01-01T00:00:00-00:00')", "TIMESTAMP '2017-02-01T00:00:00-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, ${24 * 60 * 60}, TIMESTAMP '2017-02-03T00:00:00-00:00')", "TIMESTAMP '2017-02-04T00:00:00-00:00'"),

            // add enough to flip the hour
            ExprFunctionTestCase("date_add(minute, 60, TIMESTAMP '2017-02-04T05:06:00Z')", "TIMESTAMP '2017-02-04T06:06:00+00:00'"),
            ExprFunctionTestCase("date_add(decimalSecond, ${60 * 60}, TIMESTAMP '2017-02-04T05:06:00Z')", "TIMESTAMP '2017-02-04T06:06:00+00:00'"),

            // add enough to flip the minute
            ExprFunctionTestCase("date_add(decimalSecond, 60, TIMESTAMP '2017-02-04T05:06:00Z')", "TIMESTAMP '2017-02-04T05:07:00+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-01-01T00:00:00-00:00')", "TIMESTAMP '2016-12-31T23:59:59-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-02-01T00:00:00-00:00')", "TIMESTAMP '2017-01-31T23:59:59-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-02-03T00:00:00-00:00')", "TIMESTAMP '2017-02-02T23:59:59-00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-02-03T04:05:00Z')", "TIMESTAMP '2017-02-03T04:04:59+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-02-03T04:05:06Z')", "TIMESTAMP '2017-02-03T04:05:05+00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-02-03T04:05:06.007Z')", "TIMESTAMP '2017-02-03T04:05:05.007+00:00'")
        )

        private val partiQLTimestampWithoutTimeZone = listOf(
            ExprFunctionTestCase("date_add(decimalSecond, null, TIMESTAMP '2017-01-10T05:30:55')", "null"),
            ExprFunctionTestCase("date_add(decimalSecond, 1, null)", "null"),
            ExprFunctionTestCase("date_add(decimalSecond, missing, TIMESTAMP '2017-01-10T05:30:55')", "null", "MISSING"),
            ExprFunctionTestCase("date_add(decimalSecond, 1, missing)", "null", "MISSING"),
            ...
            ExprFunctionTestCase(
                ...
                session = mapOf("a" to "1", "b" to "\$timestamp_without_timezone::{year: 2017, month: 1, day: 10, hour: 5, minute: 30, decimalSecond: 55.}").toSession()
            ),
            ExprFunctionTestCase("date_add(year, 1, TIMESTAMP '2017-01-01T00:00:00')", "TIMESTAMP '2018-01-01T00:00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, TIMESTAMP '2017-01-01T00:00:00')", "TIMESTAMP '2017-01-01T00:00:01'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, TIMESTAMP '2017-01-02T00:00:00')", "TIMESTAMP '2017-01-02T00:00:01'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, TIMESTAMP '2017-01-02T03:04:00')", "TIMESTAMP '2017-01-02T03:04:01'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, TIMESTAMP '2017-01-02T03:04:05')", "TIMESTAMP '2017-01-02T03:04:06'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, 1, TIMESTAMP '2017-01-02T03:04:05.006')", "TIMESTAMP '2017-01-02T03:04:06.006'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, ${31 * 24 * 60 * 60}, TIMESTAMP '2017-01-01T00:00:00')", "TIMESTAMP '2017-02-01T00:00:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, ${24 * 60 * 60}, TIMESTAMP '2017-02-03T00:00:00')", "TIMESTAMP '2017-02-04T00:00:00'"),

            // add enough to flip the hour
            ExprFunctionTestCase("date_add(minute, 60, TIMESTAMP '2017-02-04T05:06:00')", "TIMESTAMP '2017-02-04T06:06:00'"),
            ExprFunctionTestCase("date_add(decimalSecond, ${60 * 60}, TIMESTAMP '2017-02-04T05:06:00')", "TIMESTAMP '2017-02-04T06:06:00'"),

            // add enough to flip the minute
            ExprFunctionTestCase("date_add(decimalSecond, 60, TIMESTAMP '2017-02-04T05:06:00')", "TIMESTAMP '2017-02-04T05:07:00'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-01-01T00:00:00')", "TIMESTAMP '2016-12-31T23:59:59'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-02-01T00:00:00')", "TIMESTAMP '2017-01-31T23:59:59'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-02-03T00:00:00')", "TIMESTAMP '2017-02-02T23:59:59'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-02-03T04:05:00')", "TIMESTAMP '2017-02-03T04:04:59'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-02-03T04:05:06')", "TIMESTAMP '2017-02-03T04:05:05'"),
            ...
            ExprFunctionTestCase("date_add(decimalSecond, -1, TIMESTAMP '2017-02-03T04:05:06.007')", "TIMESTAMP '2017-02-03T04:05:05.007'")
        )

        private val addDecimalSecondTest = listOf(
            ExprFunctionTestCase("date_add(decimalSecond, 0.000000000000001, TIMESTAMP '2017-02-03T04:05:06.007')", "TIMESTAMP '2016-02-03T04:05:06.007000000000001'"),
            ExprFunctionTestCase("date_add(decimalSecond, -0.000000000000001, TIMESTAMP '2017-02-03T04:05:06.007')", "TIMESTAMP '2017-01-03T04:05:06.006999999999999'"),
            ExprFunctionTestCase("date_add(decimalSecond, 0.000000000000001, TIMESTAMP '2017-02-03T04:05:06.007+00:00')", "TIMESTAMP '2016-02-03T04:05:06.007000000000001+00:00'"),
            ExprFunctionTestCase("date_add(decimalSecond, -0.000000000000001, TIMESTAMP '2017-02-03T04:05:06.007-00:00')", "TIMESTAMP '2017-01-03T04:05:06.006999999999999-00:00'"),
            ExprFunctionTestCase("date_add(decimalSecond, 0.000000000000001, `2017-02-03T04:05:06.007`)", "TIMESTAMP '2016-02-03T04:05:06.007000000000001-00:00'"),
            ExprFunctionTestCase("date_add(decimalSecond, -0.000000000000001, `2017-02-03T04:05:06.007`)", "TIMESTAMP '2017-01-03T04:05:06.006999999999999-00:00'"),
        )
    }
