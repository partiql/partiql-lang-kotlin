...
class ThunkFactoryTests {
    ...
    companion object {
        ...
        private val STRING_SHORT = ExprValue.newString("Hello, I'm a string")
        private val STRING_LONG = ExprValue.newString("Hello, I'm a loooooooooooooooooooooooooooooooooooong string!")
        private val INT_42 = ExprValue.newInt(42)
        private val INT_42000 = ExprValue.newInt(42000)
        private val IRRELEVANT = ExprValue.newString("doesn't matter")
    ...
    internal fun thunkEnvValueUnexpectedReturnType(tc: TestCase) =
        assertInvoke(tc.expectError) {
            tc.thunkFactory.thunkEnvValue(tc.metas) { _, _ ->
                tc.thunkReturnValue
            }.invoke(Environment.standard(), ExprValue.newString("doesn't matter"))
        }
