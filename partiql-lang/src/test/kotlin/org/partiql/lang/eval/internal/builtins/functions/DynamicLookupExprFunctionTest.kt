...
class DynamicLookupExprFunctionTest : EvaluatorTestBase() {
    ...
    class ToStringPassCases : ArgumentsProviderBase() {
        override fun getParameters(): List<Any> = listOf(
            ...
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`foo`, `case_insensitive`, `locals_then_globals`, [f, b])",
                "42"
            ),
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`fOo`, `case_insensitive`, `locals_then_globals`, [f, b])",
            ...
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`foo`, `case_sensitive`, `locals_then_globals`, [f, b])",
                "42"
            ),
            // `bar` should be found in the variable b, which is also a struct
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`bar`, `case_insensitive`, `locals_then_globals`, [f, b])",
                "43"
            ),
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`BaR`, `case_insensitive`, `locals_then_globals`, [f, b])",
            ...
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`bar`, `case_sensitive`, `locals_then_globals`, [f, b])",
                "43"
            ),
            ...
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`foo`, `case_insensitive`, `globals_then_locals`, [f, b])",
                "44"
            ),
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`fOo`, `case_insensitive`, `globals_then_locals`, [f, b])",
            ...
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`foo`, `case_sensitive`, `globals_then_locals`, [f, b])",
                "44"
            ),
            // `bar` should still be found in the variable b, which is also a struct, since there is no global named `bar`.
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`bar`, `case_insensitive`, `globals_then_locals`, [f, b])",
                "43"
            ),
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`BaR`, `case_insensitive`, `globals_then_locals`, [f, b])",
            ...
            org.partiql.lang.eval.internal.builtins.ExprFunctionTestCase(
                "\"$DYNAMIC_LOOKUP_FUNCTION_NAME\"(`bar`, `case_sensitive`, `globals_then_locals`, [f, b])",
                "43"
            )
        )
    }
    ...
    @Test
    fun invalidArityTest() = org.partiql.lang.eval.internal.builtins.checkInvalidArity(
