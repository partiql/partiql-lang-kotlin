    ...
    companion object : EvaluatorTestBase() {
        ...
        val commonTestCases =
            listOf(
                ...
                listOf(
                    ...
                    case("`2007-02-23T12:14:33.079-08:00`", "$TIME_ANNOTATION::{hour:12,minute:14,decimalSecond:33.079,timezone_hour:null.int,timezone_minute:null.int}", CastQuality.LOSSY),
                    case("`2007-02T`", "$TIME_ANNOTATION::{hour:0,minute:0,decimalSecond:0.,timezone_hour:null.int,timezone_minute:null.int}", CastQuality.LOSSY),
                    case("`2007T`", "$TIME_ANNOTATION::{hour:0,minute:0,decimalSecond:0.,timezone_hour:null.int,timezone_minute:null.int}", CastQuality.LOSSY),
                    // text
                    case("'hello'", ErrorCode.EVALUATOR_CAST_FAILED),
                    case("'2016-03-01T01:12:12Z'", ErrorCode.EVALUATOR_CAST_FAILED),
        ...
        private val commonDateTimeTests = listOf(
            ...
            listOf(
                ...
                case("TIME '23:12:12.1267'", "TIME", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSLESS),
                case("TIME '23:12:12.1267-05:30'", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSLESS),
                case("TIME '23:12:12.1267+05:30'", "TIME (3)", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.127, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSY),
                case("TIME '23:12:12.1267-05:30'", "TIME (3) WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.127, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY),
                case("TIME (3) '23:12:12.1267'", "TIME", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.127, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSLESS),
                case("TIME (3) '23:12:12.1267-05:30'", "TIME", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.127, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSLESS),
                case("TIME (3) '23:12:12.1267+05:30'", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.127, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSLESS),
                case("TIME (3) '23:12:12.1267-05:30'", "TIME (9)", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.127000000, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSLESS),
                case("TIME WITH TIME ZONE '23:12:12.1267'", "TIME", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSLESS),
                case("TIME WITH TIME ZONE '23:12:12.1267-05:30'", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:-5, timezone_minute:-30}", CastQuality.LOSSLESS),
                case("TIME WITH TIME ZONE '23:12:12.1267+05:30'", "TIME (3) WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.127, timezone_hour:5, timezone_minute:30}", CastQuality.LOSSY),
                case("TIME WITH TIME ZONE '23:12:12.1267-05:30'", "TIME", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSY),
                case("TIME (3) WITH TIME ZONE '23:12:12.1267'", "TIME", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.127, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSLESS),
                case("TIME (3) WITH TIME ZONE '23:12:12.1267-05:30'", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.127, timezone_hour:-5, timezone_minute:-30}", CastQuality.LOSSLESS),
                case("TIME (3) WITH TIME ZONE '23:12:12.1267+05:30'", "TIME (5)", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.12700, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSY),
                case("TIME (3) WITH TIME ZONE '23:12:12.1267-05:30'", "TIME (5) WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.12700, timezone_hour:-5, timezone_minute:-30}", CastQuality.LOSSLESS),
                // CAST(<TIMESTAMP> AS <variants of TIME type>)
                case("`2007-02-23T12:14:33.079Z`", "TIME", "$TIME_ANNOTATION::{hour:12, minute:14, decimalSecond:33.079, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSY),
                case("`2007-02-23T12:14:33.079-08:00`", "TIME", "$TIME_ANNOTATION::{hour:12, minute:14, decimalSecond:33.079, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSY),
                case("`2007-02-23T12:14:33.079Z`", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:12, minute:14, decimalSecond:33.079, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY),
                case("`2007-02-23T12:14:33.079-08:00`", "TIME (1)", "$TIME_ANNOTATION::{hour:12, minute:14, decimalSecond:33.1, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSY),
                case("`2007-02-23T12:14:33.079-08:00`", "TIME (2) WITH TIME ZONE", "$TIME_ANNOTATION::{hour:12, minute:14, decimalSecond:33.08, timezone_hour:-8, timezone_minute:0}", CastQuality.LOSSY),
                // CAST(<text> AS <variants of TIME type>)
                case("'23:12:12.1267'", "TIME", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSLESS),
                case("'23:12:12.1267'", "TIME (2)", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.13, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSY),
                case("'23:12:12.1267'", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY),
                case("'23:12:12.1267'", "TIME (2) WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.13, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY),
                case("""`"23:12:12.1267"`""", "TIME", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSLESS),
                case("""`"23:12:12.1267"`""", "TIME (2)", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.13, timezone_hour:null.int, timezone_minute:null.int}", CastQuality.LOSSY),
                case("""`"23:12:12.1267"`""", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY),
                case("""`'23:12:12.1267'`""", "TIME (2) WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.13, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY),
        ...
        private val castDefaultTimezoneOffsetConfiguration =
            ...
            listOf(
                ...
                Pair(case("TIME '23:12:12.1267'", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSLESS), createZoneOffset()),
                Pair(case("TIME '23:12:12.1267'", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:11, timezone_minute:0}", CastQuality.LOSSLESS), createZoneOffset(11)),
                Pair(case("TIME '23:12:12.1267-05:30'", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:1, timezone_minute:0}", CastQuality.LOSSLESS), createZoneOffset(1)),
                Pair(case("TIME '23:12:12.1267-05:30'", "TIME (2) WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.13, timezone_hour:-5, timezone_minute:-30}", CastQuality.LOSSY), createZoneOffset(-5, -30)),
                // CAST(<TIMESTAMP> AS <TIME WITH TIME ZONE>)
                Pair(case("`2007-02-23T12:14:33.079Z`", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:12, minute:14, decimalSecond:33.079, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY), createZoneOffset()),
                Pair(case("`2007-02-23T12:14:33.079Z`", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:12, minute:14, decimalSecond:33.079, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY), createZoneOffset(11)),
                Pair(case("`2007-02-23T12:14:33.079-05:30`", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:12, minute:14, decimalSecond:33.079, timezone_hour:-5, timezone_minute:-30}", CastQuality.LOSSY), createZoneOffset(1)),
                Pair(case("`2007-02-23T12:14:33.079Z`", "TIME (2) WITH TIME ZONE", "$TIME_ANNOTATION::{hour:12, minute:14, decimalSecond:33.08, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY), createZoneOffset(-5, -30)),
                // CAST(<text> AS <TIME WITH TIME ZONE>)
                Pair(case("'23:12:12.1267'", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY), createZoneOffset()),
                Pair(case("'23:12:12.1267'", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:11, timezone_minute:0}", CastQuality.LOSSY), createZoneOffset(11)),
                Pair(case("'23:12:12.1267'", "TIME (2) WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.13, timezone_hour:-5, timezone_minute:-30}", CastQuality.LOSSY), createZoneOffset(-5, -30)),
                Pair(case("""`'23:12:12.1267'`""", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY), createZoneOffset()),
                Pair(case("""`'23:12:12.1267'`""", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:11, timezone_minute:0}", CastQuality.LOSSY), createZoneOffset(11)),
                Pair(case("""`'23:12:12.1267'`""", "TIME (2) WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.13, timezone_hour:-5, timezone_minute:-30}", CastQuality.LOSSY), createZoneOffset(-5, -30)),
                Pair(case("""`"23:12:12.1267"`""", "TIME WITH TIME ZONE", "$TIME_ANNOTATION::{hour:23, minute:12, decimalSecond:12.1267, timezone_hour:0, timezone_minute:0}", CastQuality.LOSSY), createZoneOffset()),
