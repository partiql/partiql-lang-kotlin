    ...
    class SubstringPassCases : ArgumentsProviderBase() {
        override fun getParameters(): List<Any> = listOf(
            ...
            ExprFunctionTestCase(
                "substring('abcdefghi' FROM 0)",
                "\"abcdefghi\""
            ),
            ExprFunctionTestCase(
                "substring('abcdefghi' FROM 1)",
                "\"abcdefghi\""
            ),
            ExprFunctionTestCase(
                "substring('abcdefghi' FROM -1)",
            ...
            ExprFunctionTestCase(
                "substring('abcdefghi' FROM 3)",
                "\"cdefghi\""
            ),
            ExprFunctionTestCase(
                "substring('abcdefghi' FROM 3 FOR 20)",
                "\"cdefghi\""
            ),
            ExprFunctionTestCase("substring('1234567890' FROM 10)", "\"0\""),
            ExprFunctionTestCase("substring('1234567890' FROM 11)", "\"\""),
            ExprFunctionTestCase(
                "substring('1234567890' FROM 10 FOR 10)",
                "\"0\""
            ),
            ExprFunctionTestCase(
                "substring('1234567890' FROM 11 FOR 10)",
                "\"\""
            ),
            ExprFunctionTestCase(
            ...
            ExprFunctionTestCase(
                "substring('abcdefghi' FROM -1 FOR 4)",
                "\"ab\""
            ),
            ExprFunctionTestCase(
                "substring('abcdefghi' FROM 1 FOR 1)",
                "\"a\""
            ),
            ExprFunctionTestCase("substring('😁😞😸😸' FROM 2 FOR 2)", "\"😞😸\""),
            ExprFunctionTestCase(
                "substring('話家身圧費谷料村能計税金' FROM 3 FOR 5)",
                "\"身圧費谷料\""
            ),
            ExprFunctionTestCase(
                "substring('話家身圧費谷料村能計税金' FROM -3 FOR 6)",
                "\"話家\""
            ),
            ExprFunctionTestCase(
            ...
            ExprFunctionTestCase(
                "substring(missing FROM 1)",
                "null",
                "$MISSING_ANNOTATION::null"
            ),
            ExprFunctionTestCase(
                "substring('abc' FROM missing)",
                "null",
                "$MISSING_ANNOTATION::null"
            ),
            ExprFunctionTestCase(
                "substring(missing FROM 1 FOR 1)",
                "null",
                "$MISSING_ANNOTATION::null"
            ),
            ExprFunctionTestCase(
                "substring('abc' FROM missing FOR 1)",
                "null",
                "$MISSING_ANNOTATION::null"
            ),
            ...
            ExprFunctionTestCase(
                "substring('話家身圧費谷料村能計税金', 3, 5)",
                "\"身圧費谷料\""
            ),
            ExprFunctionTestCase(
                "substring('話家身圧費谷料村能計税金', -3, 6)",
                "\"話家\""
            ),
            ExprFunctionTestCase(
                "substring('abcde\u0832fgh', 3, 6)",
                "\"cde\u0832fg\""
            ),
            ...
            ExprFunctionTestCase(
                "substring(missing, 1, 1)",
                "null",
                "$MISSING_ANNOTATION::null"
            ),
            ExprFunctionTestCase(
                "substring('abc', missing, 1)",
                "null",
                "$MISSING_ANNOTATION::null"
            ),
            ExprFunctionTestCase(
