...
class ExtractEvaluationTest : EvaluatorTestBase() {
    ...
    class ExtractPassCases : ArgumentsProviderBase() {
        override fun getParameters(): List<Any> = listOf(
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM null)", "null"),
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM missing)", "null", "$MISSING_ANNOTATION::null"),
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM a)", "55.", session = mapOf("a" to "2017-01-10T05:30:55Z").toSession()),
            // just year
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM `2017T`)", "0."),
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM `2017-01T`)", "0."),
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM `2017-01-02T`)", "0."),
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM `2017-01-02T03:04Z`)", "0."),
            ...
            // year, month, day, hour, minute, decimalSecond
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM `2017-01-02T03:04:05Z`)", "5."),
            ...
            // year, month, day, hour, minute, decimalSecond, local offset
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM `2017-01-02T03:04:05+07:08`)", "5."),
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM DATE '2012-12-12')", "0."),
            // TIME
            ExprFunctionTestCase("extract(hour FROM TIME '23:12:59.128')", "23."),
            ExprFunctionTestCase("extract(minute FROM TIME '23:12:59.128')", "12."),
            ExprFunctionTestCase("extract(decimalSecond FROM TIME '23:12:59.128')", "59.128"),
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM TIME (2) '23:12:59.128')", "59.13"),
            // TIME WITH TIME ZONE
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM TIME WITH TIME ZONE '23:12:59.128-06:30')", "59.128"),
            ...
            ExprFunctionTestCase("extract(decimalSecond FROM TIME (2) WITH TIME ZONE '23:12:59.128-06:30')", "59.13"),
