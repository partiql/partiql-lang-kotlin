...
import org.partiql.lang.eval.internal.ext.bytesValue
import org.partiql.lang.eval.internal.ext.codepointLeadingTrim
import org.partiql.lang.eval.internal.ext.codepointOverlay
import org.partiql.lang.eval.internal.ext.codepointPosition
import org.partiql.lang.eval.internal.ext.codepointTrailingTrim
import org.partiql.lang.eval.internal.ext.codepointTrim
import org.partiql.lang.eval.internal.ext.dateTimePartValue
import org.partiql.lang.eval.internal.ext.dateValue
import org.partiql.lang.eval.internal.ext.extractedValue
...
import org.partiql.lang.eval.internal.ext.timeValue
import org.partiql.lang.eval.internal.ext.timestampValue
import org.partiql.lang.eval.internal.ext.transformIntType
...
internal val SCALAR_BUILTINS_SQL = listOf(
    ...
    ExprFunctionSubstring_1,
    ExprFunctionSubstring_2,
    ExprFunctionTrim_1,
    ExprFunctionTrim_2,
    ExprFunctionTrim_3,
    ExprFunctionPosition,
    ExprFunctionOverlay_1,
    ExprFunctionOverlay_2,
    ExprFunctionExtract,
...
internal object ExprFunctionAbs : ExprFunctionUnaryNumeric("abs") {
    ...
    override fun call(x: Number): Number = when (x) {
        ...
        is BigDecimal -> x.abs()
            ...
            message = "Unknown number type", errorCode = ErrorCode.INTERNAL_ERROR, internal = true
        )
    }
}
...
internal object ExprFunctionMod : ExprFunction {
    ...
    override val signature = FunctionSignature(
        name = "mod", requiredParameters = listOf(StaticType.INT, StaticType.INT), returnType = StaticType.INT
    )
    ...
    override fun callWithRequired(session: EvaluationSession, required: List<ExprValue>): ExprValue {
        ...
        if (y == 0) {
            errNoContext(
                message = "Division by zero", errorCode = ErrorCode.EVALUATOR_ARITHMETIC_EXCEPTION, internal = true
            )
        }
        val result = x % y
...
internal object ExprFunctionFloor : ExprFunctionUnaryNumeric("floor") {
    ...
    override fun call(x: Number): Number = when (x) {
        java.lang.Double.POSITIVE_INFINITY, java.lang.Double.NEGATIVE_INFINITY, java.lang.Double.NaN -> x
            ...
            val d = bigDecimalOf(x).setScale(0, RoundingMode.FLOOR).toBigIntegerExact()
            d.transformIntType()
        }
    }
}
...
internal object ExprFunctionLower : ExprFunction {
    ...
    override val signature = FunctionSignature(
        name = "lower", requiredParameters = listOf(StaticType.TEXT), returnType = StaticType.STRING
    )
...
internal abstract class ExprFunctionSubstring : ExprFunction {
    protected fun substring(target: String, startPosition: Int, quantity: Int? = null): ExprValue {
...
internal object ExprFunctionSubstring_1 : ExprFunctionSubstring() {
...
internal object ExprFunctionSubstring_2 : ExprFunctionSubstring() {
 ...
 */
internal abstract class ExprFunctionTrim : ExprFunction {
    protected fun trim1Arg(sourceString: ExprValue): String = codepointTrim(sourceString.stringValue())
    ...
    protected fun trim2Arg(specificationOrToRemove: ExprValue, sourceString: ExprValue): String {
    ...
    protected fun trim3Arg(specification: ExprValue, toRemove: ExprValue, sourceString: ExprValue): String {
...
internal object ExprFunctionTrim_1 : ExprFunctionTrim() {

    override val signature = FunctionSignature(
        name = "trim", requiredParameters = listOf(StaticType.TEXT), returnType = StaticType.STRING
    )
...
internal object ExprFunctionTrim_2 : ExprFunctionTrim() {

    override val signature = FunctionSignature(
        name = "trim", requiredParameters = listOf(StaticType.TEXT, StaticType.STRING), returnType = StaticType.STRING
    )
...
internal object ExprFunctionTrim_3 : ExprFunctionTrim() {
...
internal object ExprFunctionPosition : ExprFunction {
    ...
    override val signature = FunctionSignature(
        name = "position", requiredParameters = listOf(StaticType.TEXT, StaticType.TEXT), returnType = StaticType.INT
    )
 ...
 */
internal abstract class ExprFunctionOverlay : ExprFunction {
    protected fun overlay(arg0: ExprValue, arg1: ExprValue, arg2: ExprValue, arg3: ExprValue? = null): ExprValue {
...
internal object ExprFunctionOverlay_1 : ExprFunctionOverlay() {
...
internal object ExprFunctionOverlay_2 : ExprFunctionOverlay() {
...
internal object ExprFunctionExtract : ExprFunction {
    ...
    override val signature = FunctionSignature(
        name = "extract", requiredParameters = listOf(StaticType.SYMBOL, DATETIME), returnType = StaticType.DECIMAL
    )
