...
internal class MetadataInference(
    ...
    override fun catalogExists(session: PlannerSession, catalogName: BindingName): Boolean {
        this.catalogMap.keys.forEach { if (catalogName.isEquivalentTo(it)) return true }
        return false
    }
