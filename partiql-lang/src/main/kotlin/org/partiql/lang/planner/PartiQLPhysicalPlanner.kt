...
/**
 * [PartiQLPhysicalPlanner] is responsible for transforming a [PartiqlAst.Statement] representation of a query into an
 * equivalent [PartiqlPhysical.Plan] representation of the query.
 */
@ExperimentalPartiQLCompilerPipeline
interface PartiQLPhysicalPlanner {
     ...
     *
     * If planning succeeds, this returns a [PartiQLPhysicalPlanner.Result.Success],
     * Else this returns a [PartiQLPhysicalPlanner.Result.Error].
     *
    ...
    /**
     * Options which control [PartiQLPhysicalPlanner] behavior.
     */
    class Options(
