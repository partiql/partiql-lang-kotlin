...
public interface AstVisitor<R, C> {
  ...
  public fun visitGraphMatchSelectorShortestKGroup(node: GraphMatch.Selector.ShortestKGroup,
      ctx: C): R
  ...
  public fun visitTableDefinitionColumnConstraintBody(node: TableDefinition.Column.Constraint.Body,
      ctx: C): R
