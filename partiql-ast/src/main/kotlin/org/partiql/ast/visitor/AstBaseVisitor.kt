...
public abstract class AstBaseVisitor<R, C> : AstVisitor<R, C> {
  ...
  public override fun visitStatementDMLSet(node: Statement.DML.Set, ctx: C): R = defaultVisit(node,
      ctx)
  ...
  public override fun visitStatementExplain(node: Statement.Explain, ctx: C): R = defaultVisit(node,
      ctx)
  ...
  public override fun visitStatementExplainTargetDomain(node: Statement.Explain.Target.Domain,
  ...
  public override fun visitExprIdentifier(node: Expr.Identifier, ctx: C): R = defaultVisit(node,
      ctx)
  ...
  public override fun visitExprPathStepKey(node: Expr.Path.Step.Key, ctx: C): R = defaultVisit(node,
      ctx)
  ...
  public override fun visitExprCollection(node: Expr.Collection, ctx: C): R = defaultVisit(node,
      ctx)

  public override fun visitExprTuple(node: Expr.Tuple, ctx: C): R = defaultVisit(node, ctx)

  public override fun visitExprTupleField(node: Expr.Tuple.Field, ctx: C): R = defaultVisit(node,
      ctx)
  ...
  public override fun visitExprInCollection(node: Expr.InCollection, ctx: C): R = defaultVisit(node,
      ctx)
  ...
  public override fun visitExprOuterBagOp(node: Expr.OuterBagOp, ctx: C): R = defaultVisit(node,
      ctx)
  ...
  public override fun visitFromCollection(node: From.Collection, ctx: C): R = defaultVisit(node,
      ctx)
  ...
  public override fun visitGraphMatchSelectorAnyShortest(node: GraphMatch.Selector.AnyShortest,
      ctx: C): R = defaultVisit(node, ctx)

  public override fun visitGraphMatchSelectorAllShortest(node: GraphMatch.Selector.AllShortest,
      ctx: C): R = defaultVisit(node, ctx)
  ...
  public override fun visitReturningColumn(node: Returning.Column, ctx: C): R = defaultVisit(node,
      ctx)
  ...
  public override fun visitReturningColumnValueWildcard(node: Returning.Column.Value.Wildcard,
      ctx: C): R = defaultVisit(node, ctx)

  public override fun visitReturningColumnValueExpression(node: Returning.Column.Value.Expression,
      ctx: C): R = defaultVisit(node, ctx)

  public override fun visitTableDefinition(node: TableDefinition, ctx: C): R = defaultVisit(node,
      ctx)

  public override fun visitTableDefinitionColumn(node: TableDefinition.Column, ctx: C): R =
      defaultVisit(node, ctx)

  public override fun visitTableDefinitionColumnConstraint(node: TableDefinition.Column.Constraint,
      ctx: C): R = defaultVisit(node, ctx)

  public override
      fun visitTableDefinitionColumnConstraintBody(node: TableDefinition.Column.Constraint.Body,
      ctx: C): R = when (node) {
  ...
  public override
      fun visitTableDefinitionColumnConstraintBodyNullable(node: TableDefinition.Column.Constraint.Body.Nullable,
      ctx: C): R = defaultVisit(node, ctx)

  public override
      fun visitTableDefinitionColumnConstraintBodyNotNull(node: TableDefinition.Column.Constraint.Body.NotNull,
      ctx: C): R = defaultVisit(node, ctx)

  public override
      fun visitTableDefinitionColumnConstraintBodyCheck(node: TableDefinition.Column.Constraint.Body.Check,
      ctx: C): R = defaultVisit(node, ctx)
