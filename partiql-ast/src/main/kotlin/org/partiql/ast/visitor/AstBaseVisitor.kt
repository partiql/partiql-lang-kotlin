...
public abstract class AstBaseVisitor<R, C> : AstVisitor<R, C> {
    ...
    public override fun visitTableDefinitionColumnConstraint(
        ...
        is TableDefinition.Column.Constraint.Nullable ->
            visitTableDefinitionColumnConstraintNullable(node, ctx)
        is TableDefinition.Column.Constraint.NotNull ->
            visitTableDefinitionColumnConstraintNotNull(node, ctx)
        is TableDefinition.Column.Constraint.Check -> visitTableDefinitionColumnConstraintCheck(
            node,
            ctx
        )
    }
    ...
    public override
    fun visitTableDefinitionColumnConstraintNullable(
        node: TableDefinition.Column.Constraint.Nullable,
        ctx: C
    ): R = defaultVisit(node, ctx)

    public override
    fun visitTableDefinitionColumnConstraintNotNull(
        node: TableDefinition.Column.Constraint.NotNull,
        ctx: C
    ): R = defaultVisit(node, ctx)

    public override
    fun visitTableDefinitionColumnConstraintCheck(
        node: TableDefinition.Column.Constraint.Check,
        ctx: C
    ): R = defaultVisit(node, ctx)
