...
public class StatementExplainTargetDomainBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): Statement.Explain.Target.Domain =
        factory.statementExplainTargetDomain(
...
public class ExprBetweenBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): Expr.Between = factory.exprBetween(
        id =
        id!!,
...
public class ExprSwitchBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): Expr.Switch = factory.exprSwitch(
        id =
        id!!,
        expr = expr, branches = branches, default = default
    )
}
...
public class ExprCanCastBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): Expr.CanCast = factory.exprCanCast(
        id =
        id!!,
        value = value!!, asType = asType!!
    )
...
public class ExprSfwBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): Expr.SFW = factory.exprSFW(
        id = id!!,
        select = select!!, from = from!!, let = let, where = where, groupBy = groupBy,
        having =
        having,
...
public class ExprWindowBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): Expr.Window = factory.exprWindow(
        id =
        id!!,
        function = function!!, over = over!!, args = args
    )
}
...
public class SelectStarBuilder {
    ...
    public fun quantifier(quantifier: SetQuantifier?): SelectStarBuilder = this.apply {
        this.quantifier = quantifier
    }
...
public class SelectProjectBuilder {
    ...
    public fun quantifier(quantifier: SetQuantifier?): SelectProjectBuilder = this.apply {
        this.quantifier = quantifier
    }
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): Select.Project =
        factory.selectProject(id = id!!, quantifier = quantifier!!, items = items)
}
...
public class SelectPivotBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): Select.Pivot = factory.selectPivot(
        id =
        id!!,
        value = value!!, key = key!!
    )
...
public class SelectValueBuilder {
    ...
    public fun quantifier(quantifier: SetQuantifier?): SelectValueBuilder = this.apply {
        this.quantifier = quantifier
    }
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): Select.Value = factory.selectValue(
        id =
        id!!,
        quantifier = quantifier!!, constructor = constructor!!
    )
}
...
public class FromCollectionBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): From.Collection =
        factory.fromCollection(
            id = id!!, expr = expr!!, unpivot = unpivot, asAlias = asAlias,
            atAlias =
            atAlias,
            byAlias = byAlias
        )
...
public class FromJoinBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): From.Join = factory.fromJoin(
        id =
        id!!,
        type = type!!, condition = condition, lhs = lhs!!, rhs = rhs!!
    )
}
...
public class LetBuilder {
    ...
    public var bindings: MutableList<Let.Binding> = mutableListOf()

    public fun id(id: Int?): LetBuilder = this.apply {
        this.id = id
    }

    public fun bindings(bindings: MutableList<Let.Binding>): LetBuilder = this.apply {
...
public class LetBindingBuilder {
    public var id: Int? = null
    ...
    public fun id(id: Int?): LetBindingBuilder = this.apply {
        this.id = id
    }

    public fun expr(expr: Expr?): LetBindingBuilder = this.apply {
        this.expr = expr
    }

    public fun asAlias(asAlias: String?): LetBindingBuilder = this.apply {
        this.asAlias = asAlias
    }

    public fun build(): Let.Binding = build(AstFactory.DEFAULT)

    public fun build(factory: AstFactory = AstFactory.DEFAULT): Let.Binding = factory.letBinding(
        id =
        id!!,
        expr = expr!!, asAlias = asAlias!!
    )
}
...
public class OrderBySortBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): OrderBy.Sort = factory.orderBySort(
        id =
        id!!,
...
public class GraphMatchBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): GraphMatch = factory.graphMatch(
        id =
        id!!,
        patterns = patterns, selector = selector
    )
}
...
public class GraphMatchPatternBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): GraphMatch.Pattern =
        factory.graphMatchPattern(
            id = id!!, restrictor = restrictor, prefilter = prefilter,
            variable =
            variable,
...
public class GraphMatchPatternPartNodeBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): GraphMatch.Pattern.Part.Node =
        factory.graphMatchPatternPartNode(
            id = id!!, prefilter = prefilter, variable = variable,
            label =
            label
        )
}
...
public class GraphMatchPatternPartEdgeBuilder {
    ...
    public fun build(factory: AstFactory = AstFactory.DEFAULT): GraphMatch.Pattern.Part.Edge =
        factory.graphMatchPatternPartEdge(
            id = id!!, direction = direction!!, quantifier = quantifier,
...
public class GraphMatchQuantifierBuilder {
    ...
    public fun upper(upper: Long?): GraphMatchQuantifierBuilder = this.apply {
        this.upper = upper
    }
