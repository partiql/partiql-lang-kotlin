...
public data class Let(
  ...
  public override fun <R, C> accept(visitor: AstVisitor<R, C>, ctx: C): R = visitor.visitLet(this,
      ctx)
...
public data class Over(
  ...
  public override fun <R, C> accept(visitor: AstVisitor<R, C>, ctx: C): R = visitor.visitOver(this,
      ctx)
