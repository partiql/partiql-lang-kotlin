...
public final class GroupBy extends AstNode {
    ...
    public GroupBy(@NotNull GroupByStrategy strategy, @NotNull List<Key> keys, @Nullable Identifier.Part asAlias) {
    ...
    public static class Key extends AstNode {
        ...
        public Key(@NotNull Expr expr, @Nullable Identifier.Part asAlias) {
            this.expr = expr;
            this.asAlias = asAlias;
        }
